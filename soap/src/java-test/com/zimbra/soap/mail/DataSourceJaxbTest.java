...
public class DataSourceJaxbTest {
  ...
  public void testCreateDataSourceRequest() throws JAXBException {
    ...
    assertEquals(
        "wrong refresh token",
        "AAbbccdd1244eeffVdNHR.l0_jzuWvPNtAt0BCCcOm8w9wq1gdB",
        ds.getRefreshToken());
    ...
    assertTrue(
        "DataSource should be an instance of MailImapDataSource", ds instanceof MailImapDataSource);
    ...
    assertTrue(
        "DataSource should be an instance of MailCalDataSource", ds instanceof MailCalDataSource);
    ...
    assertTrue(
        "DataSource should be an instance of MailGalDataSource", ds instanceof MailGalDataSource);
    ...
    assertTrue(
        "DataSource should be an instance of MailPop3DataSource", ds instanceof MailPop3DataSource);
    ...
    assertTrue(
        "DataSource should be an instance of MailRssDataSource", ds instanceof MailRssDataSource);
  ...
  public void testModifyDataSourceRequest() throws JAXBException {
    ...
    assertEquals(
        "Wrong ID for generic DataSource", "11e1c69c-bbb3-4f5d-8903-14ef8bdacbcc", ds.getId());
    assertTrue("DataSource should be an instance of MailDataSource", ds instanceof MailDataSource);
    assertEquals(
        "wrong refresh token",
        "AAbbccdd1244eeffVdNHR.l0_jzuWvPNtAt0BCCcOm8w9wq1gdB",
    ...
    assertEquals(
        "Wrong ID for IMAP DataSource", "71e1c69c-bbb3-4f5d-8903-14ef8bdacbcc", ds.getId());
    assertTrue(
        "DataSource should be an instance of MailImapDataSource", ds instanceof MailImapDataSource);
    assertEquals("wrong polling interval", "30m", ds.getPollingInterval());
    ...
    assertEquals(
        "Wrong ID for POP3 DataSource", "41e1c69c-bbb3-4f5d-8903-14ef8bdacbcc", ds.getId());
    assertTrue(
        "DataSource should be an instance of MailPop3DataSource", ds instanceof MailPop3DataSource);
    ...
    assertEquals(
        "Wrong ID for Caldav DataSource", "31e1c69c-bbb3-4f5d-8903-14ef8bdacbcc", ds.getId());
    assertTrue(
        "DataSource should be an instance of MailCaldavDataSource",
        ds instanceof MailCaldavDataSource);
    assertEquals("wrong polling interval", "60s", ds.getPollingInterval());
  ...
  public void testGetDataSourcesResponse() throws Exception {
    ...
    assertNotNull("Generic DataSource ID should not be NULL", ds.getId());
    assertEquals(
        "Wrong ID for generic DataSource", "8d17e182-fdc6-4f6c-b83f-d478c9b04bfd", ds.getId());
    assertTrue("DataSource should be an instance of MailDataSource", ds instanceof MailDataSource);
    assertEquals(
        "wrong refresh token",
        "AAbbcdd22wkBVsVdNHR.l0_jzuWvPNiAt0DBOcRm7w9zLorEM",
        ds.getRefreshToken());
    assertEquals("wrong host", "yahoo.com", ds.getHost());
    assertEquals("wrong import class", "com.synacor.zimbra.OAuthDataImport", ds.getImportClass());
    ...
    assertNotNull("IMAP DataSource ID should not be NULL", ds.getId());
    assertEquals(
        "Wrong ID for IMAP DataSource", "d96e9a7d-6af9-4625-ba68-37bcd73fce6d", ds.getId());
    assertTrue(
        "DataSource should be an instance of MailImapDataSource", ds instanceof MailImapDataSource);
    ...
    assertNotNull("POP3 DataSource ID should not be NULL", ds.getId());
    assertEquals(
        "Wrong ID for POP3 DataSource", "b5e98a1f-5f93-4e19-a1a4-956c4c95af1b", ds.getId());
    assertTrue(
        "DataSource should be an instance of MailPop3DataSource", ds instanceof MailPop3DataSource);
    assertEquals("wrong connectionType", ConnectionType.cleartext, ds.getConnectionType());
    ...
    assertTrue(
        "DataSource should be an instance of MailCalDataSource", ds instanceof MailGalDataSource);
    ...
    assertNotNull("Caldav DataSource ID should not be NULL", ds.getId());
    assertEquals(
        "Wrong ID for Caldav DataSource", "95c066a8-5ad6-40fa-a094-06f8b3531878", ds.getId());
    assertTrue(
        "DataSource should be an instance of MailCaldavDataSource",
        ds instanceof MailCaldavDataSource);
    ...
    assertEquals(
        "Wrong ID for the 2d RSS DataSource", "f32349af-9a78-4c26-80a1-338203378930", ds.getId());
    assertTrue(
        "DataSource should be an instance of MailRssDataSource", ds instanceof MailRssDataSource);
    assertEquals("wrong connectionType", ConnectionType.cleartext, ds.getConnectionType());
    ...
    assertEquals(
        "Wrong ID for the 2d IMAP DataSource", "b2e929f5-e124-47a0-b1b4-a7fbcd14fb31", ds.getId());
    assertTrue(
        "DataSource should be an instance of MailImapDataSource", ds instanceof MailImapDataSource);
  ...
  public void testImportDataRequest() throws Exception {
    ...
    assertEquals(
        "Wrong ID for generic DataSource", "8d17e182-fdc6-4f6c-b83f-d478c9b04bfd", ds.getId());
    assertTrue(
        "DataSource should be an instance of DataSourceNameOrId", ds instanceof DataSourceNameOrId);
    ...
    assertEquals(
        "Wrong ID for IMAP DataSourceNameOrId", "d96e9a7d-6af9-4625-ba68-37bcd73fce6d", ds.getId());
    assertTrue(
    ...
    assertEquals(
        "Wrong ID for POP3 DataSourceNameOrId", "d96e9a7d-6af9-4625-ba68-37bcd73fce6d", ds.getId());
    assertTrue(
    ...
    assertNotNull("POP3 DataSourceNameOrId ID should not be NULL", ds.getId());
    assertEquals(
        "Wrong ID for RSS DataSourceNameOrId", "21e1c69c-bbb3-4f5d-8903-14ef8bdacbcc", ds.getId());
    assertTrue(
