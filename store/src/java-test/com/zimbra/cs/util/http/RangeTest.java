...
public class RangeTest {
  ...
  public void parseReversedRange() throws Exception {
    assertThrows(RangeException.class, () -> Range.parse("bytes=200-100"));
  }

  @Test
  public void parseNegativeEndValue() throws Exception {
    assertThrows(RangeException.class, () -> Range.parse("bytes=100--200"));
  }
  ...
  public void parseGarbage() throws Exception {
    assertThrows(RangeException.class, () -> Range.parse("garbage"));
  }

  @Test
  public void parseNoValues() throws Exception {
    assertThrows(RangeException.class, () -> Range.parse("-"));
  }
}
