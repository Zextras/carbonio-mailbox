...
public class ContentRangeTest {
  ...
  public void parseReversedRange() throws Exception {
    assertThrows(RangeException.class, () -> ContentRange.parse("bytes 200-100/777"));
  }

  @Test
  public void parseRangeTooBig() throws Exception {
    assertThrows(RangeException.class, () -> ContentRange.parse("bytes 0-100/50"));
  }

  @Test
  public void parseNegativeInstanceLength() throws Exception {
    assertThrows(RangeException.class, () -> ContentRange.parse("bytes 0-100/-1000"));
  }
  ...
  public void parseGarbage() throws Exception {
    assertThrows(RangeException.class, () -> ContentRange.parse("garbage"));
  }
}
