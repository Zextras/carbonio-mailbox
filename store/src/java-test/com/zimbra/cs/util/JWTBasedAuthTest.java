...
public class JWTBasedAuthTest {
  ...
  private String generateJWT(Account acct, String salt)
    ...
    AuthTokenProperties properties =
        new AuthTokenProperties(acct, false, null, expires, null, Usage.AUTH);
  ...
  public void testGetJWToken() {
    ...
    try {
      ...
      long expires = issuedAt + 3600000;
      AuthTokenProperties properties =
          new AuthTokenProperties(acct, true, null, expires, AuthMech.zimbra, Usage.AUTH);
      String jwt = JWTUtil.generateJWT(jwtKey, salt, issuedAt, properties, atkey.getVersion());
