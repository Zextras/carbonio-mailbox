...
public class GenerateEphemeralGettersTest {
  ...
  public void testStringGetters() throws Exception {
    ...
    String getter =
        "    public String getEphemeralAttribute() throws"
            ...
            + "        return getEphemeralAttr(Provisioning.A_zimbraEphemeralAttribute,"
            + " null).getValue(null);\n"
            + "    }";
    ...
    String setter =
        "    public void setEphemeralAttribute(String zimbraEphemeralAttribute,"
            ...
            + " com.zimbra.common.service.ServiceException {\n"
            + "        modifyEphemeralAttr(Provisioning.A_zimbraEphemeralAttribute, null,"
  ...
  public void testMultiStringGetters() throws Exception {
    ...
    String adder =
        "    public void addEphemeralAttribute(String dynamicComponent, String"
            ...
            + "        modifyEphemeralAttr(Provisioning.A_zimbraEphemeralAttribute,"
    ...
    String has =
        "    public boolean hasEphemeralAttribute(String dynamicComponent) throws"
            + " com.zimbra.common.service.ServiceException {\n"
            + "        return hasEphemeralAttr(Provisioning.A_zimbraEphemeralAttribute,"
            + " dynamicComponent);\n"
            + "    }";
  ...
  public void testEnumGetters() throws Exception {
    ...
    String getter =
        "    public ZAttrProvisioning.EphemeralAttribute getEphemeralAttribute() throws"
            + " com.zimbra.common.service.ServiceException {\n"
            + "        try { String v = getEphemeralAttr(Provisioning.A_zimbraEphemeralAttribute,"
            + " null).getValue(); return v == null ? null :"
            + " ZAttrProvisioning.EphemeralAttribute.fromString(v); }"
  ...
  public void testDurationGetters() throws Exception {
    ...
    String getter =
        "    public long getEphemeralAttribute() throws com.zimbra.common.service.ServiceException"
            + " {\n"
            + "        return getEphemeralTimeInterval(Provisioning.A_zimbraEphemeralAttribute,"
            + " null, -1L);\n"
            + "    }";
  ...
  public void testTimeGetters() throws Exception {
    ...
    String getter =
        "    public Date getEphemeralAttribute() throws com.zimbra.common.service.ServiceException"
            + " {\n"
            + "        String v = getEphemeralAttr(Provisioning.A_zimbraEphemeralAttribute,"
