  ...
  public void testTaskRecurrenceDuration() throws ServiceException, UnsupportedEncodingException {
    ...
    String task =
        "BEGIN:VCALENDAR\n"
            ...
            + "ATTENDEE;CN=User"
            + " Test;CUTYPE=RESOURCE;ROLE=NON-PARTICIPANT;PARTSTAT=NEEDS-ACTION:mailto:testuser@zimbra.com\n"
            + "ATTENDEE;CN=User"
            + " Test;ROLE=OPT-PARTICIPANT;PARTSTAT=NEEDS-ACTION:mailto:testuser@zimbra.com\n"
            + "PRIORITY:5\n"
            + "PERCENT-COMPLETE:0\n"
