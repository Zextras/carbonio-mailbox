...
public class AclPushSerializerTest {
   ...
   * com.zimbra.cs.mailbox.acl.AclPushSerializer#serialize(com.zimbra.cs.account.ShareInfoData)} .
   */
  @Test
  ...
  /**
   * Test method for {@link
   * com.zimbra.cs.mailbox.acl.AclPushSerializer#deserialize(java.lang.String)} .
   */
  @Test
  public void testDeserialize() {
    String shareInfoData =
        "granteeId:7ad43260-e8c0-423a-a3e5-bdaa51ec11d5;granteeName:user3@rdesai.local;granteeType:usr;folderId:258;folderUuid:886d073c-00d5-429e-b8d3-4f7385d32109;folderPath:/Inbox/Test;"
            + " Bed;folderDefaultView:message;rights:r;type:folder";
    ...
    try {
      ...
      shareInfoData =
          "granteeId:7ad43260-e8c0-423a-a3e5-bdaa51ec11d5;granteeName:user3@rdesai.local;granteeType:usr;folderId:258;folderUuid:886d073c-00d5-429e-b8d3-4f7385d32109;folderPath:/Inbox/Test*ASCII59*"
              + " Bed;folderDefaultView:message;rights:r;type:folder";
      ...
      shareInfoData =
          "granteeId:7ad43260-e8c0-423a-a3e5-bdaa51ec11d5;granteeName:user3@rdesai.local;granteeType:usr;folderId:258;folderUuid:886d073c-00d5-429e-b8d3-4f7385d32109;folderPath:/Inbox/TestASCII59"
              + " Bed;folderDefaultView:message;rights:r;type:folder";
      data = AclPushSerializer.deserialize(shareInfoData);
      path = data.getPath();
      ...
      shareInfoData =
          "granteeId:7ad43260-e8c0-423a-a3e5-bdaa51ec11d5;granteeName:user3@rdesai.local;granteeType:usr;folderId:258;folderUuid:886d073c-00d5-429e-b8d3-4f7385d32109;folderPath:/Inbox/Test*ASCII59*"
              + " Bed*ASCII59* 123;folderDefaultView:message;rights:r;type:folder";
      data = AclPushSerializer.deserialize(shareInfoData);
      path = data.getPath();
