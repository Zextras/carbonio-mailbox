...
public class PurgeTest {
  ...
  @Test
  public void purgeSent() throws Exception {
    // Set retention policy
    Account account = getAccount();
  ...
  @Test
  public void purgeBatchSize() throws Exception {
    Account account = getAccount();
    account.setMailPurgeUseChangeDateForTrash(false);
    account.setPrefTrashLifetime("24h");
  ...
  public void testSpamChangeDate() throws Exception {
    ...
    assertTrue("Unexpected message date: " + kept.getDate(), kept.getDate() < cutoff);
    assertTrue("Unexpected change date: " + kept.getChangeDate(), kept.getChangeDate() > cutoff);
  ...
  @Test
  public void testRecentFolderInTrashChangeDate() throws Exception {
  ...
  @Test
  public void testRecentFolderInTrashNoChangeDate() throws Exception {
  ...
  public void completeRetentionPolicy() throws Exception {
    ...
    RetentionPolicy mboxRP =
        new RetentionPolicy(Arrays.asList(Policy.newSystemPolicy(keep1.getId())), null);
  ...
  public void completeCosRetentionPolicy() throws Exception {
    ...
    RetentionPolicy mboxRP1 =
        new RetentionPolicy(Arrays.asList(Policy.newSystemPolicy(keep2.getId())), null);
   ...
   */
  @Test
  public void testExpiredIMAPDeletedOnChangeDate() throws Exception {
    Account account = getAccount();
    account.setMailTrashLifetime("24h");
   ...
   */
  @Test
  public void testNotExpiredIMAPDeletedOnChangeDate() throws Exception {
    Account account = getAccount();
    account.setMailTrashLifetime("24h");
