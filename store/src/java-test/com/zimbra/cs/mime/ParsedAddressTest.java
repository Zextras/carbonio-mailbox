...
public final class ParsedAddressTest {
  ...
  @Test
  public void address() {
    new Helper("prefix lastname")
        .first("Della")
        .last("Gonzales")
        .runAddressTest("     \"Della Gonzales\" <rvhxhjyjxugp@example.com>");
    new Helper("trailing dash is delimiter")
        .first("Stan")
        .last("O'Neal")
        .suffix("Chairman, CEO & President")
        .runAddressTest(
            "     \"Stan O'Neal - Chairman, CEO & President\" <antifraudcentre@example.com>");
    new Helper("chinese square brackets")
        .first("\u53B3\u9078\u60C5\u5831")
        .runAddressTest("=?iso-2022-jp?B?GyRCIVo4N0EqPnBKcyFbGyhC?=<teresa@example.com>");
    new Helper("1-character name")
        .first("\u97FF")
    ...
    new Helper("email in name")
        .first("peerless_p_0@yahoo.co.jp")
        .runAddressTest(
            "=?iso-2022-jp?B?cGVlcmxlc3NfcF8wQHlhaG9vLmNvLmpw?=<peerless_p_0@example.co.jp>");
    // TODO failing
    // new Helper("leading dash is
    // delimiter").first("Janine").last("Gr\u00FCndel").suffix("Intergroove")
    //    .runAddressTest("=?iso-8859-1?Q?Janine_Gr=FCndel_-Intergroove-?=
    // <JanineGruendel@example.com>");
    // TODO failing
    // new Helper("honorific middle
    // name").first("\u0424\u0443\u043D\u043A\u0446\u0438\u0438").middle("\u0432\u043D.")
    //    .last("\u0430\u0443\u0434\u0438\u0442\u0430")
    ...
    new Helper("suffix honorific w/o dot")
        .first("Emerich")
        .middle("R")
        .last("Winkler")
        .suffix("Jr")
    ...
    // TODO failing
    // new Helper("nonstandard suffix honorific w/o
    // dot").first("Farai").last("Aggrey").suffix("jnr")
    ...
    //    .runAddressTest("\"Comercial Ideas & Dise=?iso-8859-1?b?8Q==?=o\"
    // <ideasydiseno@example.es>");
    new Helper("trailing !")
        .first("Eli")
        .last("Stevens")
        .suffix("Y!")
        .runAddressTest("\"Eli Stevens (Y!)\" <elis@example.com>");
    new Helper("trailing comma")
        .first("Ewald")
        .last("de Bever")
        .suffix("Mr")
        .runAddressTest("\"Ewald de Bever (Mr),\"<verbever1@example.com>");
    new Helper("Inc. means company")
        .first("Flickerbox")
        .runAddressTest("\"Flickerbox, Inc.\" <paul@example.com>");
    new Helper("retain delimiters in suffix")
        .first("Cory")
        .last("Goligoski")
        .suffix("MENLO PARK, CA")
    ...
    new Helper("multi-dashes as delimiter")
        .first("John")
        .last("Katsaros")
        .suffix("Internet Research Group")
        .runAddressTest("\"John Katsaros -- Internet Research Group\" <jkatsar1169@example.net>");
    new Helper("retain delimiters in suffix")
        .first("Louis")
        .last("Ferreira")
        .suffix("BCX - Microsoft Competency")
        .runAddressTest(
            "\"Louis Ferreira - BCX - Microsoft Competency\" <Louis.Ferreira@example.co.za>");
    // TODO failing
    // new Helper("ampersand means company").first("Macworld")
    //    .runAddressTest("\"Macworld Conference & Expo\" <macworldexpo@example.com>");
    new Helper("colon as delimiter")
        .first("Montgomery")
        .last("Research")
        .suffix("Midmarket Strategies")
    ...
    new Helper("roman numeral")
        .first("Philip")
        .middle("W.")
        .last("Dalrymple")
        .suffix("III")
        .runAddressTest("\"Philip W. Dalrymple III\" <pwd@example.com>");
    new Helper("multiple honorifics")
        .honorific("Prof. Dr.")
        .first("Karl-Heinz")
        .last("Kunzelmann")
    ...
    new Helper("trailing apostrophe")
        .first("Rene'")
        .middle("N.")
        .last("Godwin")
        .runAddressTest("\"Rene' N. Godwin\" <godwin4@example.net>");
    new Helper("nonduplicate addr")
        .first("Reuven")
        .last("Cohen")
        .suffix("ruvnet@gmail.com")
        .runAddressTest("\"Reuven Cohen [ruvnet@gmail.com]\" <ruv@example.com>");
    new Helper("middle name abbr")
        .first("Robert")
        .middle("Q.H.")
        .last("Bui")
        .runAddressTest("\"Robert Q.H. Bui\" <robertb@example.com.au>");
    new Helper("bar as delimiter")
        .first("Sander")
        .last("Manneke")
        .suffix("Internet Today")
        .runAddressTest("\"Sander Manneke | Internet Today\" <s.manneke@example.nl>");
    new Helper("at-sign delimiter")
        .first("Avis")
        .last("Scheffler")
        .suffix("P-f-i-z-e-r Supplies")
        .runAddressTest(
            "\"Scheffler, Avis @ -P-f-i-z-e-r Supplies\""
                + " <turryeaProducts.Registration5876@example.com>");
    // TODO failing
    ...
    new Helper("retain delimiters in suffix")
        ...
        .suffix("MENLO PARK, CA")
        .runAddressTest("\"Goligoski, Cory (MENLO PARK, CA)\" <cory_r_goligoski@example.com>");
    new Helper("terminal abbr")
        .first("interWays")
        .runAddressTest("\"interWays e.K.\" <info@example.de>");
    new Helper("multi-dashes as delimiter")
        .first("John")
        .last("Katsaros")
        .suffix("Internet Research Group")
    ...
    new Helper("multiple honorifics")
        ...
        .last("Kunzelmann")
        .runAddressTest("\"Prof. Dr. Karl-Heinz Kunzelmann\" <karl-heinz@example.de>");
    new Helper("drailing apostrophe")
        .first("Rene'")
        .middle("N.")
        .last("Godwin")
        .runAddressTest("\"Rene' N. Godwin\" <godwin4@example.net>");
  ...
  private void runNameSuite(String first, String last) {
    new Helper("first last").first(first).last(last).runNameTest(first + ' ' + last);
    new Helper("hon. first last")
        .honorific("Mr.")
        .first(first)
        .last(last)
        .runNameTest("Mr. " + first + ' ' + last);
    new Helper("first last, suf")
        .first(first)
        .last(last)
        .suffix("MD")
        .runNameTest(first + ' ' + last + ", MD");
    new Helper("first last num")
        .first(first)
        .last(last)
        .suffix("III")
    ...
    new Helper("last, first").first(first).last(last).runNameTest(last + ", " + first);
    new Helper("last, hon. first")
        .first(first)
        .last(last)
        .honorific("Prof.")
        .runNameTest(last + ", Prof. " + first);
    new Helper("last, first, suf")
        .first(first)
        .last(last)
        .suffix("M.D.")
  ...
  private void runNameSuite(String first, String middle, String last) {
    ...
    new Helper("first middle last")
        .first(first)
        .middle(middle)
        .last(last)
        .runNameTest(first + ' ' + middle + ' ' + last);
    new Helper("hon. first middle last")
        .honorific("Gov.")
        .first(first)
        .middle(middle)
        .last(last)
        .runNameTest("Gov. " + first + ' ' + middle + ' ' + last);
    new Helper("first middle last, abbr")
        .first(first)
        .middle(middle)
        .last(last)
        .suffix("M.D.")
        .runNameTest(first + ' ' + middle + ' ' + last + " M.D.");
    new Helper("first middle last num")
        .first(first)
        .middle(middle)
        .last(last)
        .suffix("III")
        .runNameTest(first + ' ' + middle + ' ' + last + " III");
    new Helper("first middle last (suf)")
        .first(first)
        .middle(middle)
        .last(last)
        .suffix("dec'd")
    ...
    new Helper("last, first middle")
        .first(first)
        .middle(middle)
        .last(last)
        .runNameTest(last + ", " + first + ' ' + middle);
    new Helper("last, hon. first middle")
        .honorific("Dr.")
        .first(first)
        .middle(middle)
        .last(last)
        .runNameTest(last + ", Dr. " + first + ' ' + middle);
    new Helper("last, first middle, suf")
        .first(first)
        .middle(middle)
        .last(last)
        .suffix("Ph.D.")
