...
public final class PatchInputStreamTest {
  ...
  public void negativeZeroLengthRef() throws Exception {
    ...
    assertThrows(InvalidPatchReferenceException.class, () -> createDocument(mbox, "filename", pis));
  }
  ...
  public void negativeZeroLengthData() throws Exception {
    ...
    assertThrows(BadPatchFormatException.class, () -> createDocument(mbox, "filename", pis));
  }
