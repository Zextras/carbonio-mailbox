...
public final class SmtpTransportTest {
  ...
  public void send() throws Exception {
    ...
    MimeMessage msg =
        new ZMimeMessage(
            session, new SharedByteArrayInputStream(raw.getBytes(Charsets.ISO_8859_1)));
  ...
  public void nullMailFrom() throws Exception {
    ...
    String raw = "From: sender@zimbra.com\nTo: rcpt@zimbra.com\nSubject: test\n\ntest";
    SMTPMessage msg =
        new SMTPMessage(session, new SharedByteArrayInputStream(raw.getBytes(Charsets.ISO_8859_1)));
