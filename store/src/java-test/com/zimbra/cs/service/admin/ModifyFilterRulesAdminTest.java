...
public class ModifyFilterRulesAdminTest {
  ...
  public void testSoapToSieveAddheaderActionWithoutLast() throws ServiceException, Exception {
    ...
    RuleManager.setAdminRulesFromXML(
        account, filterRules, FilterType.INCOMING, AdminFilterType.BEFORE);
  ...
  public void testSoapToSieveDeleteheaderAction2() throws ServiceException, Exception {
    ...
    String script =
        "require ["
            ...
            + ", \"editheader\"];\n\n"
            + "# rule1\n"
            + "deleteheader :comparator \"i;ascii-casemap\" :is \"X-Test-Header\" \"Test"
            + " value\";\n";
  ...
  public void testSoapToSieveDeleteheaderAction3() throws ServiceException, Exception {
    ...
    String script =
        "require ["
            ...
            + ", \"editheader\"];\n\n"
            + "# rule1\n"
            + "deleteheader :comparator \"i;ascii-casemap\" :is \"X-Test-Header\" [ \"Value1\","
            + " \"Value2\", \"Value3\" ];\n";
  ...
  public void testSoapToSieveDeleteheaderAction4() throws ServiceException, Exception {
    ...
    values.add("Value3");
    EditheaderTest test =
        new EditheaderTest("contains", null, null, null, "i;octet", "X-Test-Header", values);
    DeleteheaderAction action = new DeleteheaderAction(null, null, test);
    FilterRule filterRule = new FilterRule("rule1", true);
    filterRule.addFilterAction(action);
    List<FilterRule> filterRules = new ArrayList<FilterRule>();
    ...
    String script =
        "require ["
            ...
            + ", \"editheader\"];\n\n"
            + "# rule1\n"
            + "deleteheader :comparator \"i;octet\" :contains \"X-Test-Header\" [ \"Value1\","
            + " \"Value2\", \"Value3\" ];\n";
  ...
  public void testSoapToSieveDeleteheaderAction5() throws ServiceException, Exception {
    ...
    values.add("2");
    EditheaderTest test =
        new EditheaderTest(null, null, true, "ge", "i;ascii-numeric", "X-Test-Header", values);
    DeleteheaderAction action = new DeleteheaderAction(null, null, test);
    FilterRule filterRule = new FilterRule("rule1", true);
    filterRule.addFilterAction(action);
    List<FilterRule> filterRules = new ArrayList<FilterRule>();
    ...
    String script =
        "require ["
            ...
            + ", \"editheader\"];\n\n"
            + "# rule1\n"
            + "deleteheader :value \"ge\" :comparator \"i;ascii-numeric\" \"X-Test-Header\""
            + " \"2\";\n";
  ...
  public void testSoapToSieveDeleteheaderAction7() throws ServiceException, Exception {
    ...
    values.add("2");
    EditheaderTest test =
        new EditheaderTest(null, true, null, "ge", "i;ascii-numeric", "X-Test-Header", values);
    DeleteheaderAction action = new DeleteheaderAction(null, null, test);
    FilterRule filterRule = new FilterRule("rule1", true);
    filterRule.addFilterAction(action);
    List<FilterRule> filterRules = new ArrayList<FilterRule>();
  ...
  public void testSoapToSieveReplaceheaderAction2() throws ServiceException, Exception {
    ...
    String script =
        "require ["
            ...
            + ", \"editheader\"];\n\n"
            + "# rule1\n"
            + "replaceheader :newvalue \"[test] ${1}\" :comparator \"i;ascii-casemap\" :is"
  ...
  public void testSoapToSieveReplaceheaderAction4() throws ServiceException, Exception {
    ...
    String script =
        "require ["
            ...
            + ", \"editheader\"];\n\n"
            + "# rule1\n"
            + "replaceheader :newvalue \"[test] ${1}\" :comparator \"i;octet\" :contains"
            + " \"X-Test-Header\" [ \"Value1\", \"Value2\", \"Value3\" ];\n";
  ...
  public void testSoapToSieveReplaceheaderAction5() throws ServiceException, Exception {
    ...
    String script =
        "require ["
            ...
            + ", \"editheader\"];\n\n"
            + "# rule1\n"
            + "replaceheader :newvalue \"[test] ${1}\" :value \"ge\" :comparator"
            + " \"i;ascii-numeric\" \"X-Test-Header\" \"2\";\n";
  ...
  public void testSoapToSieveReplaceheaderAction7() throws ServiceException, Exception {
    ...
    EditheaderTest test =
        new EditheaderTest(null, true, null, "ge", "i;ascii-numeric", "X-Test-Header", values);
    ReplaceheaderAction action =
        new ReplaceheaderAction(null, null, test, "X-Test-Header-New", "[test] ${1}");
    FilterRule filterRule = new FilterRule("rule1", true);
    filterRule.addFilterAction(action);
    List<FilterRule> filterRules = new ArrayList<FilterRule>();
    filterRules.add(filterRule);
    ...
    String script =
        "require ["
            ...
            + ", \"editheader\"];\n\n"
            + "# rule1\n"
            + "replaceheader :newname \"X-Test-Header-New\" :newvalue \"[test] ${1}\" :count \"ge\""
            + " :comparator \"i;ascii-numeric\" \"X-Test-Header\" \"2\";\n";
