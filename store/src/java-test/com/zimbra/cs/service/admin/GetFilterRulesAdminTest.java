...
public class GetFilterRulesAdminTest {
  private static final String ACCOUNTNAME =
      "test1_zcs273_" + System.currentTimeMillis() + "@zimbra.com";
  ...
  public void negativeTestSieveToSoapAddheaderAction2() throws ServiceException {
    ...
    try {
      ...
      Assert.assertEquals(
          se.getMessage(),
          "parse error: Invalid addheader action: Missing headerName or headerValue");
    }
  }
  ...
  public void testSieveToSoapDeleteheaderActionBasicWithValue() throws ServiceException {
    ...
    String script =
        "require [\"editheader\"];\n"
            + "# rule1\n"
            + "deleteheader \"X-My-Header\" \"Test Value\";"; // matchType and comparator should be
    // added by default
    account.setAdminSieveScriptBefore(script);
  ...
  public void testSieveToSoapDeleteheaderActionWithIndex() throws ServiceException {
    ...
    String script =
        "require [\"editheader\"];\n"
            + "# rule1\n"
            + "deleteheader :index 3 \"X-My-Header\" \"Test Value\";"; // matchType and comparator
  ...
  public void testSieveToSoapDeleteheaderActionWithIndexAndLast() throws ServiceException {
    ...
    String script =
        "require [\"editheader\"];\n"
            + "# rule1\n"
            + "deleteheader :last :index 3 \"X-My-Header\" \"Test Value\";"; // matchType and
  ...
  @Test
  public void testSieveToSoapDeleteheaderActionWithIndexAndLastWithoutValue()
  ...
  public void testSieveToSoapDeleteheaderActionWithMultiValue() throws ServiceException {
    ...
    String script =
        "require [\"editheader\"];\n"
            + "# rule1\n"
            + "deleteheader :last :index 3 :comparator \"i;octet\" :contains \"X-My-Header\""
            + " [\"Value1\", \"Value2\"];";
    account.setAdminSieveScriptBefore(script);
  ...
  @Test
  public void testSieveToSoapDeleteheaderActionWithValueAndRelationalComparator()
      throws ServiceException {
    RuleManager.clearCachedRules(account);
    String script =
        "require [\"editheader\"];\n"
            + "# rule1\n"
            + "deleteheader :last :index 3 :value \"ge\" :comparator \"i;ascii-numeric\""
            + " \"X-My-Header\" \"2\";";
    account.setAdminSieveScriptBefore(script);
  ...
  @Test
  public void testSieveToSoapDeleteheaderActionWithCountAndRelationalComparator()
      throws ServiceException {
    RuleManager.clearCachedRules(account);
    String script =
        "require [\"editheader\"];\n"
            + "# rule1\n"
            + "deleteheader :last :index 3 :count \"ge\" :comparator \"i;ascii-numeric\""
            + " \"X-My-Header\" \"2\";";
    account.setAdminSieveScriptBefore(script);
  ...
  public void negativeTestSieveToSoapDeleteheaderAction1() throws ServiceException {
    ...
    String script =
        "require [\"editheader\"];\n"
            + "# rule1\n"
            + "deleteheader :last :index 3 :comparator \"i;octet\" :asdf \"X-My-Header\""
            + " [\"Value1\", \"Value2\"];";
    account.setAdminSieveScriptBefore(script);
    ...
    try {
      ...
      Assert.assertEquals(
          se.getMessage(), "parse error: Invalid tag \":asdf\" received with deleteheader");
    }
  }
  ...
  public void negativeTestSieveToSoapDeleteheaderAction2() throws ServiceException {
    ...
    String script =
        "require [\"editheader\"];\n"
            + "# rule1\n"
            + "deleteheader :last :index :comparator \"i;octet\" \"X-My-Header\" [\"Value1\","
            + " \"Value2\"];";
    account.setAdminSieveScriptBefore(script);
    ...
    try {
      ...
      Assert.assertEquals(
          se.getMessage(), "parse error: Invalid value \":comparator\" received with \":index\"");
    }
  }
  ...
  public void negativeTestSieveToSoapDeleteheaderAction4() throws ServiceException {
    ...
    String script =
        "require [\"editheader\"];\n"
            + "# rule1\n"
            + "deleteheader :last :index 3 :count \"ge\" :comparator \"i;ascii-numeric\" :is"
            + " \"X-My-Header\" \"2\";";
    account.setAdminSieveScriptBefore(script);
    ...
    try {
      ...
      Assert.assertEquals(
          se.getMessage(),
          "parse error: EditheaderTest : :count or :value can not be used with matchType");
    }
  }
  ...
  @Test
  public void testSieveToSoapReplaceheaderActionBasicWithNewnameAndNewvaue()
      throws ServiceException {
    RuleManager.clearCachedRules(account);
    String script =
        "require [\"editheader\", \"variables\"];\n"
            + "# rule1\n"
            + "replaceheader :newname \"X-My-Header2\" :newvalue \"[new] ${1}\" \"X-My-Header\""
            + " \"xyz\";";
    account.setAdminSieveScriptBefore(script);
  ...
  public void testSieveToSoapReplaceheaderActionBasicWithComparator() throws ServiceException {
    ...
    String script =
        "require [\"editheader\", \"variables\"];\n"
            + "# rule1\n"
            + "replaceheader :newname \"X-My-Header2\" :newvalue \"[new] ${1}\" :comparator"
            + " \"i;octet\" \"X-My-Header\" \"xyz\";";
    account.setAdminSieveScriptBefore(script);
  ...
  @Test
  public void testSieveToSoapReplaceheaderActionBasicWithComparatorAndMatchType()
      throws ServiceException {
    RuleManager.clearCachedRules(account);
    String script =
        "require [\"editheader\", \"variables\"];\n"
            + "# rule1\n"
            + "replaceheader :newname \"X-My-Header2\" :newvalue \"[new] ${1}\" :comparator"
            + " \"i;octet\" :contains \"X-My-Header\" \"xyz\";";
    account.setAdminSieveScriptBefore(script);
  ...
  @Test
  public void testSieveToSoapReplaceheaderActionBasicWithRelationalComparatorAndValue()
      throws ServiceException {
    RuleManager.clearCachedRules(account);
    String script =
        "require [\"editheader\", \"variables\"];\n"
            + "# rule1\n"
            + "replaceheader :newname \"X-My-Header2\" :newvalue \"[new] ${1}\" :comparator"
            + " \"i;ascii-numeric\" :value \"ge\" \"X-My-Header\" \"2\";";
    account.setAdminSieveScriptBefore(script);
  ...
  @Test
  public void testSieveToSoapReplaceheaderActionBasicWithRelationalComparatorAndCount()
      throws ServiceException {
    RuleManager.clearCachedRules(account);
    String script =
        "require [\"editheader\", \"variables\"];\n"
            + "# rule1\n"
            + "replaceheader :newname \"X-My-Header2\" :newvalue \"[new] ${1}\" :comparator"
            + " \"i;ascii-numeric\" :count \"eq\" \"X-My-Header\" \"3\";";
    account.setAdminSieveScriptBefore(script);
  ...
  public void testSieveToSoapReplaceheaderActionBasicWithIndex() throws ServiceException {
    ...
    String script =
        "require [\"editheader\", \"variables\"];\n"
            + "# rule1\n"
            + "replaceheader :index 4 :newname \"X-My-Header2\" :newvalue \"[new] ${1}\""
            + " :comparator \"i;ascii-numeric\" :count \"eq\" \"X-My-Header\" \"3\";";
    account.setAdminSieveScriptBefore(script);
  ...
  public void testSieveToSoapReplaceheaderActionBasicWithLastAndIndex() throws ServiceException {
    ...
    String script =
        "require [\"editheader\", \"variables\"];\n"
            + "# rule1\n"
            + "replaceheader :last :index 2 :newname \"X-My-Header2\" :newvalue \"[new] ${1}\""
            + " :comparator \"i;ascii-numeric\" :count \"eq\" \"X-My-Header\" \"3\";";
    account.setAdminSieveScriptBefore(script);
  ...
  public void negativeTestSieveToSoapReplaceheaderAction() throws ServiceException {
    ...
    String script =
        "require [\"editheader\", \"variables\"];\n"
            + "# rule1\n"
            + "replaceheader :last :newname \"X-My-Header2\" :newvalue \"[new] ${1}\" :comparator"
            + " \"i;ascii-numeric\" :count \"eq\" \"X-My-Header\" \"3\";";
    account.setAdminSieveScriptBefore(script);
    ...
    try {
      ...
      Assert.assertEquals(
          "parse error: :index <offset> must be provided with :last", se.getMessage());
    }
  }
  ...
  public void negativeTestSieveToSoapReplaceheaderAction2() throws ServiceException {
    ...
    String script =
        "require [\"editheader\", \"variables\"];\n"
            + "# rule1\n"
            + "replaceheader :last :index :newname \"X-My-Header2\" :newvalue \"[new] ${1}\""
            + " :comparator \"i;ascii-numeric\" :count \"eq\" \"X-My-Header\" \"3\";";
    account.setAdminSieveScriptBefore(script);
    ...
    try {
      ...
      Assert.assertEquals(
          "parse error: Invalid value \":newname\" received with \":index\"", se.getMessage());
    }
  }
  ...
  public void negativeTestSieveToSoapReplaceheaderAction3() throws ServiceException {
    ...
    String script =
        "require [\"editheader\", \"variables\"];\n"
            + "# rule1\n"
            + "replaceheader :last :index 2 :comparator \"i;ascii-numeric\" :count \"eq\""
            + " \"X-My-Header\" \"3\";";
    account.setAdminSieveScriptBefore(script);
    ...
    try {
      ...
      Assert.assertEquals(
          "parse error: :newname or :newvalue must be provided with replaceHeader",
          se.getMessage());
    }
  }
}
