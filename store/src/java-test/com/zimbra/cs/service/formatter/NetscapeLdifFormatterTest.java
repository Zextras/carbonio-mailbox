...
public class NetscapeLdifFormatterTest {
  ...
  public void testContactLDIFFormat() throws Exception {
    try {
      ...
      contact.put(
          "nickname",
          "nick "); // test value gets base64 encoded if it contains last SPACE character
      ...
      contact.put(
          "mobilePhone",
          "<9876543210>"); // test value gets base64 encoded if it contains Non SAFE-INIT-CHAR(<)

      StringBuilder sb = new StringBuilder();
      String[] galLdapAttrMap = {
      ...
      String expectedResult =
          "dn: cn=user2,email=user2@zimbra.com\r\n"
              + "objectClass: top\r\n"
              + "objectClass: person\r\n"
