...
public class SyncTest {
  ...
  public void tags() throws Exception {
    ...
    Assert.assertFalse(
        "sync token change after tag color",
        token.equals(response.getAttribute(MailConstants.A_TOKEN)));
  ...
  public void msgConversationsCutoff() throws Exception {
    ...
    Pair<Integer, Element> pairFolderIdElement =
        new Pair<Integer, Element>(Mailbox.ID_FOLDER_CONVERSATIONS, null);
  ...
  public void conversations() throws Exception {
    ...
    for (String delete : deletedIds) {
      Assert.assertTrue(
          "id " + delete + " deleted", expectedDeletes.remove(Integer.valueOf(delete)));
    }
