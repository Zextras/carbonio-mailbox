...
public class TagActionTest {
  ...
  public void byId() throws Exception {
    ...
    action
        .addAttribute(MailConstants.A_OPERATION, ItemAction.OP_COLOR)
  ...
  public void invalid() throws Exception {
    ...
    try {
      ...
      Assert.assertEquals(
          ...
          MailServiceException.NO_SUCH_TAG,
          e.getCode());
    }
  }
  ...
  public void permissions() throws Exception {
    ...
    action
        .addAttribute(MailConstants.A_TAG_NAMES, (String) null)
  ...
  public void delete() throws Exception {
    ...
    request
        .addUniqueElement(MailConstants.E_TAG)
        .addAttribute(MailConstants.A_COLOR, 4)
    ...
    request
        .addUniqueElement(MailConstants.E_ACTION)
