...
public class SendShareNotificationTest extends SendShareNotification {
  ...
  protected MimeMessage generateShareNotification(
      ...
      ShareInfoData sid,
      String notes,
      SendShareNotificationRequest.Action action,
      Collection<String> internalRecipients,
      String externalRecipient)
      throws ServiceException, MessagingException {
    MimeMessage mm =
        super.generateShareNotification(
  ...
  public void shareByOwner() throws Exception {
    ...
    request
        ...
        .addAttribute(MailConstants.A_ADDRESS, "test2@zimbra.com");
  ...
  public void shareByAdmin() throws Exception {
    ...
    Element request = new Element.XMLElement(MailConstants.SEND_SHARE_NOTIFICATION_REQUEST);
    request
        .addElement(MailConstants.E_ITEM)
        .addAttribute(MailConstants.A_ID, new ItemId(acct.getId(), f.getId()).toString());
    request
        .addElement(MailConstants.E_EMAIL)
        .addAttribute(MailConstants.A_ADDRESS, "test3@zimbra.com");
    handle(request, ServiceTestUtil.getRequestContext(acct));
  }
