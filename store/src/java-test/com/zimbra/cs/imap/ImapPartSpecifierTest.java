...
public class ImapPartSpecifierTest {
  ...
  private void checkBody(
      MimeMessage mm, String part, String modifier, String startsWith, String endsWith)
  ...
  public void structure() throws Exception {
    ...
    checkBody(
        ...
        "",
        "HEADER",
        "X-Gmail-Received: ea9cadad8b81db887fe7ca769a31384c1468b618",
    ...
    checkBody(
        ...
        "1",
        "",
        "This is the Postfix program at host mta02.zimbra.com.",
    ...
    checkBody(
        ...
        "2",
        "",
        "Reporting-MTA: dns; mta02.zimbra.com",
