...
public final class NioImapDecoderTest {
  ...
  public void setUp() throws ServiceException {
    ...
    session.setTransportMetadata(
        new DefaultTransportMetadata(
            ...
            "test",
            false,
            true, // Enable fragmentation
            SocketAddress.class,
            IoSessionConfig.class,
            Object.class));
  }
  ...
  public void decodeLiteral() throws Exception {
    IN.clear()
        .putString("A003 APPEND Drafts (\\Seen \\Draft $MDNSent) CATENATE (TEXT {10}\r\n", CHARSET)
        .flip();
    decoder.decode(session, IN, session.getDecoderOutput());
    Assert.assertEquals(
        "A003 APPEND Drafts (\\Seen \\Draft $MDNSent) CATENATE (TEXT {10}",
