...
public class ReplaceHeaderTest {
  ...
  private static String sampleBaseMsg =
      "Received: from edge01e.zimbra.com ([127.0.0.1])\n"
          ...
          + "X-Header-With-Control-Chars1:"
          + " =?utf-8?B?dGVzdCBIVAkgVlQLIEVUWAMgQkVMByBCUwggbnVsbAAgYWZ0ZXIgbnVsbA0K?=\n"
  ...
  private static String sampleBaseMsg2 =
      "Received: from edge01e.zimbra.com ([127.0.0.1])\n"
          ...
          + "Subject: example\n"
          + "to: test@zimbra.com\n";
  private static String sampleBaseMsg3 =
      "Received: from edge01e.zimbra.com ([127.0.0.1])\n"
          + "\tby localhost (edge01e.zimbra.com [127.0.0.1]) (amavisd-new, port 10032)\n"
          + "\twith ESMTP id DN6rfD1RkHD7; Fri, 24 Jun 2016 01:45:31 -0400 (EDT)\n"
          + "Received: from localhost (localhost [127.0.0.1])\n"
          ...
          + "Subject: example\n"
          + "to: test@zimbra.com\n";
  private static String sampleBaseMsg4 =
      "Received: from edge01e.zimbra.com ([127.0.0.1])\n"
          + "\tby localhost (edge01e.zimbra.com [127.0.0.1]) (amavisd-new, port 10032)\n"
          + "\twith ESMTP id DN6rfD1RkHD7; Fri, 24 Jun 2016 01:45:31 -0400 (EDT)\n"
          + "Received: from localhost (localhost [127.0.0.1])\n"
          ...
          + "Subject: example\n"
          + "to: test@zimbra.com\n";
  private static String sampleBaseMsg5 =
      "Received: from edge01e.zimbra.com ([127.0.0.1])\n"
          + "\tby localhost (edge01e.zimbra.com [127.0.0.1]) (amavisd-new, port 10032)\n"
          + "\twith ESMTP id DN6rfD1RkHD7; Fri, 24 Jun 2016 01:45:31 -0400 (EDT)\n"
          + "Received: from localhost (localhost [127.0.0.1])\n"
  ...
  private static String sampleBaseMsg8 =
      "Received: from edge01e.zimbra.com ([127.0.0.1])\n"
          + "\tby localhost (edge01e.zimbra.com [127.0.0.1]) (amavisd-new, port 10032)\n"
          + "\twith ESMTP id DN6rfD1RkHD7; Fri, 24 Jun 2016 01:45:31 -0400 (EDT)\n"
          + "Received: from localhost (localhost [127.0.0.1])\n"
  ...
  public void testReplaceHeaderAtIndex() {
    try {
      String filterScript =
          "require [\"editheader\"];\n"
              + " replaceheader :index 2 :newvalue \"new test\" :contains \"X-Test-Header\""
              + " \"test\" \r\n"
              + "  ;\n";
      Account acct1 = Provisioning.getInstance().get(Key.AccountBy.name, "test@zimbra.com");
      Mailbox mbox1 = MailboxManager.getInstance().getMailboxByAccount(acct1);
  ...
  public void testReplaceLastHeader() {
    try {
      String filterScript =
          "require [\"editheader\"];\n"
              + " replaceheader :last :index 1 :newvalue \"new test\" :contains \"X-Test-Header\""
              + " \"test\" \r\n"
              + "  ;\n";
      Account acct1 = Provisioning.getInstance().get(Key.AccountBy.name, "test@zimbra.com");
      Mailbox mbox1 = MailboxManager.getInstance().getMailboxByAccount(acct1);
  ...
  public void testReplaceSecondFromBottomHeader() {
    try {
      String filterScript =
          "require [\"editheader\"];\n"
              + " replaceheader :index 2 :last :newvalue \"new test\" :contains \"X-Test-Header\""
              + " \"test\" \r\n"
              + "  ;\n";
      Account acct1 = Provisioning.getInstance().get(Key.AccountBy.name, "test@zimbra.com");
      Mailbox mbox1 = MailboxManager.getInstance().getMailboxByAccount(acct1);
  ...
  public void testReplaceNoValuePattern() {
    try {
      String filterScript =
          "require [\"editheader\"];\n"
              + " replaceheader :newname \"X-New-Header\" :newvalue \"new value\" :comparator"
              + " \"i;ascii-casemap\" :matches \"Subject\" \r\n"
              + "  ;\n";
      Account acct1 = Provisioning.getInstance().get(Key.AccountBy.name, "test@zimbra.com");
      Mailbox mbox1 = MailboxManager.getInstance().getMailboxByAccount(acct1);
    ...
    try {
      String filterScript =
          "require [\"editheader\", \"relational\", \"comparator-i;ascii-numeric\"];\n"
              + " replaceheader :newname \"X-Numeric2-Header\" :newvalue \"0\" :value \"lt\""
              + " :comparator \"i;ascii-numeric\" \"X-Numeric-Header\" \"3\" \r\n"
              + "  ;\n";
      Account acct1 = Provisioning.getInstance().get(Key.AccountBy.name, "test@zimbra.com");
      Mailbox mbox1 = MailboxManager.getInstance().getMailboxByAccount(acct1);
  ...
  public void testReplaceHeaderWithNumericComparisionUsingCount() {
    try {
      String filterScript =
          "require [\"editheader\", \"relational\", \"comparator-i;ascii-numeric\"];\n"
              + " replaceheader :newname \"X-Numeric2-Header\" :count \"ge\" :comparator"
              + " \"i;ascii-numeric\" \"X-Numeric-Header\" \"3\" \r\n"
              + "  ;\n";
      Account acct1 = Provisioning.getInstance().get(Key.AccountBy.name, "test@zimbra.com");
      Mailbox mbox1 = MailboxManager.getInstance().getMailboxByAccount(acct1);
  ...
  public void testReplaceHeaderWithXSpamScore() {
    try {
      String filterScript =
          "require [\"editheader\", \"variables\", \"relational\","
              + " \"comparator-i;ascii-numeric\"];\n"
              + "if anyof(header :value \"ge\" :comparator \"i;ascii-numeric\" [\"X-Spam-Score\"]"
              + " [\"80\"]) {      if exists \"Subject\" {        replaceheader :newvalue"
              + " \"[SPAM]${1}\" :matches \"Subject\" \"*\";      } else {        addheader :last"
              + " \"Subject\" \"[SPAM]\";      }    }";
      Account acct1 = Provisioning.getInstance().get(Key.AccountBy.name, "test@zimbra.com");
      Mailbox mbox1 = MailboxManager.getInstance().getMailboxByAccount(acct1);
    ...
    try {
      String filterScript =
          "require [\"editheader\", \"variables\"];\n"
              + "        replaceheader :newvalue \"${1}[test]${2}\" :matches \"X-Test-Header\""
              + " \"*line2*\";";
      Account acct1 = Provisioning.getInstance().get(Key.AccountBy.name, "test@zimbra.com");
      Mailbox mbox1 = MailboxManager.getInstance().getMailboxByAccount(acct1);
      ...
      RuleManager.applyRulesToIncomingMessage(
          new OperationContext(mbox1),
          mbox1,
          new ParsedMessage(sampleBaseMsg2.getBytes(), false),
          0,
          acct1.getName(),
          null,
          new DeliveryContext(),
  ...
  public void testReplaceHeaderForEncodedHeaderValue() {
    try {
      ...
      RuleManager.applyRulesToIncomingMessage(
          new OperationContext(mbox1),
          mbox1,
          new ParsedMessage(sampleBaseMsg3.getBytes(), false),
          0,
          acct1.getName(),
          null,
          new DeliveryContext(),
  ...
  public void testReplaceHeaderForInvalidEncodedMultilineHeaderValue() {
    try {
      ...
      RuleManager.applyRulesToIncomingMessage(
          new OperationContext(mbox1),
          mbox1,
          new ParsedMessage(sampleBaseMsg4.getBytes(), false),
          0,
          acct1.getName(),
          null,
          new DeliveryContext(),
  ...
  public void testReplaceHeaderForValidEncodedMultilineHeaderValue() {
    try {
      ...
      RuleManager.applyRulesToIncomingMessage(
          new OperationContext(mbox1),
          mbox1,
          new ParsedMessage(sampleBaseMsg5.getBytes(), false),
          0,
          acct1.getName(),
          null,
          new DeliveryContext(),
  ...
  public void testReplaceHeaderNonAsciiVariables() {
    try {
      ...
      RuleManager.applyRulesToIncomingMessage(
          new OperationContext(mbox1),
          mbox1,
          new ParsedMessage(sampleBaseMsg6.getBytes(), false),
          0,
          acct1.getName(),
          null,
          new DeliveryContext(),
      ...
      Assert.assertEquals(
          "=?UTF-8?B?W+i/veWKoF3ku7blkI3jgafjgZnjgILku7blkI3jga/jgq3jg6Pjg6njgq8=?=\r\n"
    ...
    try {
      ...
      List<ItemId> ids =
          RuleManager.applyRulesToIncomingMessage(
              ...
              mbox,
              new ParsedMessage(triggeringMsg.toString().getBytes(), false),
              0,
              account.getName(),
              null,
              new DeliveryContext(),
  ...
  public void testReplaceHeaderFromBottom() {
    try {
      String filterScript =
          "require [\"editheader\"];\n"
              + " replaceheader :index 1 :last :newvalue \"new test1\" :contains \"X-Test-Header\""
              + " \"test\";\n"
              + " replaceheader :index 2 :last :newvalue \"new test2\" :contains \"X-Test-Header\""
              + " \"test\";\n"
              + " replaceheader :index 3 :last :newvalue \"new test3\" :contains \"X-Test-Header\""
              + " \"test\";\n"
              + " replaceheader :index 4 :last :newvalue \"new test4\" :contains \"X-Test-Header\""
              + " \"test\";\n"
              + " replaceheader :index 5 :last :newvalue \"new test5\" :contains \"X-Test-Header\""
              + " \"test\";\n"
              + " replaceheader :index 6 :last :newvalue \"new test6\" :contains \"X-Test-Header\""
              + " \"test\";\n";
      Account acct1 = Provisioning.getInstance().get(Key.AccountBy.name, "test@zimbra.com");
      Mailbox mbox1 = MailboxManager.getInstance().getMailboxByAccount(acct1);
      ...
      RuleManager.applyRulesToIncomingMessage(
          new OperationContext(mbox1),
          mbox1,
          new ParsedMessage(sampleBaseMsg8.getBytes(), false),
          0,
          acct1.getName(),
          null,
          new DeliveryContext(),
  ...
  public void testReplaceHeaderWithCaseMapComparatorUsingValue() {
    try {
      String filterScript =
          "require [\"editheader\", \"relational\", \"comparator-i;ascii-numeric\"];\n"
              + " replaceheader :newname \"X-Test2-Header\" :newvalue \"0\" :value \"lt\""
              + " :comparator \"i;ascii-casemap\" \"X-Test-Header\" \"test2\" \r\n"
              + "  ;\n";
      Account acct1 = Provisioning.getInstance().get(Key.AccountBy.name, "test@zimbra.com");
      Mailbox mbox1 = MailboxManager.getInstance().getMailboxByAccount(acct1);
  ...
  public void testReplaceHeaderWithoutMatchType() {
    try {
      String filterScript =
          "require [\"editheader\"];\n"
              + " replaceheader :newname \"X-Test2-Header\" :newvalue \"0\" \"X-Test-Header\""
              + " \"test2\" \r\n"
              + "  ;\n";
      Account acct1 = Provisioning.getInstance().get(Key.AccountBy.name, "test@zimbra.com");
      Mailbox mbox1 = MailboxManager.getInstance().getMailboxByAccount(acct1);
  ...
  public void testReplaceHeaderWithEmptyHeaderNewName() {
    try {
      String filterScript =
          "require [\"editheader\", \"relational\"];\n"
              + " replaceheader :newname \"\" :newvalue \"0\" :value \"lt\" :comparator"
              + " \"i;ascii-casemap\" \"X-Test-Header\" \"test2\" \r\n"
              + "  ;\n";
      Account acct1 = Provisioning.getInstance().get(Key.AccountBy.name, "test@zimbra.com");
      Mailbox mbox1 = MailboxManager.getInstance().getMailboxByAccount(acct1);
  ...
  public void testReplaceHeaderStartingWithSpacesAsHeaderNewName() {
    try {
      String filterScript =
          "require [\"editheader\", \"relational\"];\n"
              + " replaceheader :newname \" asdf\" :newvalue \"0\" :value \"lt\" :comparator"
              + " \"i;ascii-casemap\" \"X-Test-Header\" \"test2\" \r\n"
              + "  ;\n";
      Account acct1 = Provisioning.getInstance().get(Key.AccountBy.name, "test@zimbra.com");
      Mailbox mbox1 = MailboxManager.getInstance().getMailboxByAccount(acct1);
  ...
  public void testReplaceHeaderStartingWithSpacesAsHeaderName() {
    try {
      String filterScript =
          "require [\"editheader\"];\n"
              + " replaceheader :newname \"X-Test-New-Name\" :newvalue \"0\" :value \"lt\""
              + " :comparator \"i;ascii-casemap\" \" X-Test-Header\" \"test2\" \r\n"
              + "  ;\n";
      Account acct1 = Provisioning.getInstance().get(Key.AccountBy.name, "test@zimbra.com");
      Mailbox mbox1 = MailboxManager.getInstance().getMailboxByAccount(acct1);
  ...
  public void testReplaceHeaderNewNameFromCondition() {
    try {
      String filterScript =
          "require [\"editheader\", \"variables\"];\n"
              + "replaceheader :newname \"${1}\" :newvalue \"${2}\" :matches \"X-Test-Header\""
              + " \"t*t*\";\n";
      Account acct1 = Provisioning.getInstance().get(Key.AccountBy.name, "test@zimbra.com");
      Mailbox mbox1 = MailboxManager.getInstance().getMailboxByAccount(acct1);
  ...
  public void testImmutableHeaders() {
    ...
    try {
      ...
      Assert.assertEquals(
          "7bit", message.getMimeMessage().getHeader("Content-Transfer-Encoding")[0]);
      Assert.assertEquals("1.0", message.getMimeMessage().getHeader("MIME-Version")[0]);
      Assert.assertEquals(
          "auto-generated", message.getMimeMessage().getHeader("Auto-Submitted")[0]);
    } catch (Exception e) {
      fail("No exception should be thrown: " + e.getMessage());
    }
  }
    ...
    try {
      String sampleBaseMsg =
          "Received: from edge01e.zimbra.com ([127.0.0.1])\n"
              ...
              + "to: test@zimbra.com\n";
      String filterScript =
          "require [\"editheader\", \"comparator-i;ascii-numeric\"];\n"
              + "replaceheader :newvalue \"New Value\" :is :comparator \"i;ascii-numeric\""
              + " \"Subject\" \"1\";\n";
      Account acct1 = Provisioning.getInstance().get(Key.AccountBy.name, "test@zimbra.com");
      Mailbox mbox1 = MailboxManager.getInstance().getMailboxByAccount(acct1);
      RuleManager.clearCachedRules(acct1);
  ...
  public void testNonAsciiHeaderName() {
    ...
    try {
      ...
      Assert.assertEquals(
          "ReplaceHeader:Header name must be printable ASCII only.", e.getMessage());
    }
  }
  ...
  public void testNonAsciiHeaderNameWithoutOperation() {
    ...
    try {
      ...
      Assert.assertEquals(
          "EditHeaderExtension:Header name must be printable ASCII only.", e.getMessage());
    }
  }
    ...
    try {
      ...
      List<ItemId> ids =
          RuleManager.applyRulesToIncomingMessage(
              ...
              mbox,
              new ParsedMessage(
                  "X-Mal-Encoded-Header: =?ABC?A?GyRCJFskMhsoQg==?=".getBytes(), false),
              0,
              account.getName(),
              new DeliveryContext(),
              Mailbox.ID_FOLDER_INBOX,
  ...
  public void testMissingComparatorNumericDeclaration() throws Exception {
    ...
    String script =
        "require [\"editheader\"];\n"
            + "replaceheader :newvalue \"20\" :comparator \"i;ascii-numeric\" \"X-Numeric-Header\""
            + " \"2\";";
    try {
      Account account = Provisioning.getInstance().get(Key.AccountBy.name, "test@zimbra.com");
      Mailbox mbox = MailboxManager.getInstance().getMailboxByAccount(account);
  ...
  public void testBackslashAsciiCasemap4bs() throws Exception {
    ...
    String script =
        "require [\"editheader\"];\n"
            + "replaceheader :newvalue \"replaced\" :comparator \"i;ascii-casemap\" \"X-Header\" "
            + " \"Sample\\\\\\\\\\\\\\\\Pattern\";replaceheader :newvalue \"replaced\" :comparator"
            + " \"i;ascii-casemap\" \"X-HeaderA\" \"Sample\\\\\\\\Pattern\";replaceheader :newvalue"
            + " \"replaced\" :comparator \"i;ascii-casemap\" \"X-HeaderB\""
            + " \"Sample\\\\Pattern\";replaceheader :newvalue \"replaced\" :comparator"
            + " \"i;ascii-casemap\" \"X-HeaderC\""
            + " \"Sample\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\Pattern\";";
  ...
  public void testBackslashAsciiCasemap5bs() throws Exception {
    ...
    String script =
        "require [\"editheader\"];\n"
            + "replaceheader :newvalue \"replaced\" :comparator \"i;ascii-casemap\" \"X-Header\" "
            + " \"Sample\\\\\\\\\\\\\\\\\\\\Pattern\";replaceheader :newvalue \"replaced\""
            + " :comparator \"i;ascii-casemap\" \"X-HeaderA\""
            + " \"Sample\\\\\\\\\\Pattern\";replaceheader :newvalue \"replaced\" :comparator"
            + " \"i;ascii-casemap\" \"X-HeaderB\" \"Sample\\\\\\Pattern\";replaceheader :newvalue"
            + " \"replaced\" :comparator \"i;ascii-casemap\" \"X-HeaderC\""
            + " \"Sample\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\Pattern\";";
    String pattern = "Sample\\\\\\\\\\Pattern";
    String msg =
        "X-Header: "
  ...
  public void testBackslashOctet() throws Exception {
    String script =
        "require [\"editheader\"];\n"
            + "replaceheader :newvalue \"replaced\" :comparator \"i;octet\" \"X-Header\" "
            + " \"Sample\\\\\\\\\\\\\\\\Pattern\";replaceheader :newvalue \"replaced\" :comparator"
            + " \"i;octet\" \"X-HeaderA\" \"Sample\\\\\\\\Pattern\";replaceheader :newvalue"
            + " \"replaced\" :comparator \"i;octet\" \"X-HeaderB\""
            + " \"Sample\\\\Pattern\";replaceheader :newvalue \"replaced\" :comparator \"i;octet\""
            + " \"X-HeaderC\" \"Sample\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\Pattern\";";
    String pattern = "Sample\\\\\\\\Pattern";
    String msg =
        "X-Header: "
            + pattern
    ...
    try {
      ...
      List<ItemId> ids =
          RuleManager.applyRulesToIncomingMessage(
              new OperationContext(mbox),
              mbox,
              new ParsedMessage(msg.getBytes(), false),
              0,
              account.getName(),
              new DeliveryContext(),
              Mailbox.ID_FOLDER_INBOX,
