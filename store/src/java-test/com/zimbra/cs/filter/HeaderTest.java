...
public class HeaderTest {
  ...
  public void testNumericNegativeValueValue() {
    String filterScript =
        "require [\"fileinto\", \"tag\", \"flag\", \"log\", \"relational\","
            + " \"comparator-i;ascii-numeric\"];\n"
            + "if header :value \"ge\" :comparator \"i;ascii-numeric\" [\"X-Spam-score\"] [\"500\"]"
            + " { tag \"XSpamScore\";}tag \"Negative\";";
    doTest(filterScript, null);
  }
  ...
  public void testNumericNegativeValueCounts() {
    String filterScript =
        "require [\"fileinto\", \"tag\", \"flag\", \"log\", \"relational\","
            + " \"comparator-i;ascii-numeric\"];\n"
            + "if header :count \"ge\" :comparator \"i;ascii-numeric\" [\"Received\"] [\"-1\"] {"
            + " tag \"Received\";}tag \"Negative\";";
    doTest(filterScript, null);
  }
  ...
  public void testNumericNegativeValueIs() {
    String filterScript =
        "require [\"fileinto\", \"tag\", \"flag\", \"log\", \"relational\","
            + " \"comparator-i;ascii-numeric\"];\n"
            + "if header :is :comparator \"i;ascii-numeric\" [\"X-Spam-score\"] [\"-5\"] { tag"
            + " \"XSpamScore\";}tag \"Negative\";";
    doTest(filterScript, null);
  }
  ...
  public void testNumericMinusCharacterValueIs() {
    String filterScript =
        "require [\"fileinto\", \"tag\", \"flag\", \"log\", \"relational\","
            + " \"comparator-i;ascii-numeric\"];\n"
            + "if header :is :comparator \"i;ascii-numeric\" [\"X-Minus\"] [\"\"] { tag"
            + " \"Xminus\";}";
  ...
  public void testNumericEmptyIs() {
    String filterScript =
        "require [\"fileinto\", \"tag\", \"flag\", \"log\", \"relational\","
            + " \"comparator-i;ascii-numeric\"];\n"
            + "if header :is :comparator \"i;ascii-numeric\" [\"Subject\"] [\"\"] { tag"
            + " \"subject\";}";
  ...
  public void RFC822Attached() throws Exception {
    ...
    account.setMailSieveScript(
        "if header :is \"Subject\" \"Attached HTML message\" { flag \"priority\"; }");
    Mailbox mbox = MailboxManager.getInstance().getMailboxByAccount(account);
  ...
  public void fileAttached() throws Exception {
    ...
    RuleManager.clearCachedRules(account);
    account.setMailSieveScript(
        "if header :contains \"Content-Disposition\" \"attachment.txt\" { flag \"priority\"; }");
    Mailbox mbox = MailboxManager.getInstance().getMailboxByAccount(account);
   ...
   *       \\)
   *   <li>a header with three backslashes match a filter with three sets of escaped backslash (\\ x
   *       3)
   *   <li>a header with four backslashes match a filter with four sets of escaped backslash (\\ x
   *       4)
   *   <li>a header with five backslashes match a filter with five sets of escaped backslash (\\ x
   *       5)
   *   <li>when the nested-if tests the same header (X-HeaderN), the same value matches both outer
   *       and inner 'if' condition.
   * </ul>
   *
   * @throws Exception
   */
  ...
  public void testBackslash() throws Exception {
    String script =
        "require [\"variables\"];\n"
            + "if header :matches \"X-Header1\" \"sample\\\\pattern\"             { tag \"01\"; }if"
            + " header :matches \"X-Header2\" \"sample\\\\\\\\pattern\"         { tag \"02\"; }if"
            + " header :matches \"X-Header3\" \"sample\\\\\\\\\\\\pattern\"     { tag \"03\"; }if"
            + " header :matches \"X-Header4\" \"sample\\\\\\\\\\\\\\\\pattern\" { tag \"04\"; }if"
            + " header :matches \"X-Header5\" \"sample\\\\\\\\\\\\\\\\\\\\\"    { tag \"05\"; }if"
            + " header :matches \"X-Header1\" \"*\" { set \"var1\" \"${1}\"; if header :matches"
            + " \"X-Header1\" \"${var1}\" { tag \"11\"; }}if header :matches \"X-Header2\" \"*\" {"
            + " set \"var2\" \"${1}\"; if header :matches \"X-Header2\" \"${var2}\" { tag \"12\";"
            + " }}if header :matches \"X-Header3\" \"*\" { set \"var3\" \"${1}\"; if header"
            + " :matches \"X-Header3\" \"${var3}\" { tag \"13\"; }}if header :matches \"X-Header4\""
            + " \"*\" { set \"var4\" \"${1}\"; if header :matches \"X-Header4\" \"${var4}\" { tag"
            + " \"14\"; }}if header :matches \"X-Header5\" \"*\" { set \"var5\" \"${1}\"; if header"
            + " :matches \"X-Header5\" \"${var5}\" { tag \"15\"; }}if header :comparator"
            + " \"i;octet\" :matches \"X-Header1\" \"sample\\\\pattern\"             { tag \"21\";"
            + " }if header :comparator \"i;octet\" :matches \"X-Header2\" \"sample\\\\\\\\pattern\""
            + "         { tag \"22\"; }if header :comparator \"i;octet\" :matches \"X-Header3\""
            + " \"sample\\\\\\\\\\\\pattern\"     { tag \"23\"; }if header :comparator \"i;octet\""
            + " :matches \"X-Header4\" \"sample\\\\\\\\\\\\\\\\pattern\" { tag \"24\"; }if header"
            + " :comparator \"i;octet\" :matches \"X-Header5\" \"sample\\\\\\\\\\\\\\\\\\\\\"    {"
            + " tag \"25\"; }if header :comparator \"i;octet\" :matches \"X-Header1\" \"*\" { set"
            + " \"var1\" \"${1}\"; if header :comparator \"i;octet\" :matches \"X-Header1\""
            + " \"${var1}\" { tag \"31\"; }}if header :comparator \"i;octet\" :matches"
            + " \"X-Header2\" \"*\" { set \"var2\" \"${1}\"; if header :comparator \"i;octet\""
            + " :matches \"X-Header2\" \"${var2}\" { tag \"32\"; }}if header :comparator"
            + " \"i;octet\" :matches \"X-Header3\" \"*\" { set \"var3\" \"${1}\"; if header"
            + " :comparator \"i;octet\" :matches \"X-Header3\" \"${var3}\" { tag \"33\"; }}if"
            + " header :comparator \"i;octet\" :matches \"X-Header4\" \"*\" { set \"var4\""
            + " \"${1}\"; if header :comparator \"i;octet\" :matches \"X-Header4\" \"${var4}\" {"
            + " tag \"34\"; }}if header :comparator \"i;octet\" :matches \"X-Header5\" \"*\" { set"
            + " \"var5\" \"${1}\"; if header :comparator \"i;octet\" :matches \"X-Header5\""
            + " \"${var5}\" { tag \"35\"; }}";
    String sourceMsg =
