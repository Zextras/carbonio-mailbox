...
public class RelationalExtensionTest {
  ...
  public void testCountAddressNumericGE2() {
    ...
    String filterScript =
        "require [\"relational\", \"tag\", \"comparator-i;ascii-numeric\"];\n"
  ...
  public void testCountHeaderNumericGE1() {
    ...
    String filterScript =
        "require [\"fileinto\", \"tag\", \"flag\", \"log\", \"relational\","
            ...
            + "if header :count \"ge\" :comparator \"i;ascii-numeric\" [\"received\"] [\"3\"] { tag"
            + " \"Priority\";} else { tag \"No Priority\";}";
    doTest(filterScript, "No Priority");
  }
  ...
  public void testCountHeaderNumericGE2() {
    ...
    String filterScript =
        "require [\"fileinto\", \"tag\", \"flag\", \"log\", \"relational\","
            + " \"comparator-i;ascii-numeric\"];\n"
            + "if header :count \"ge\" :comparator \"i;ascii-numeric\" [\"received\", \"subject\"]"
            + " [\"3\"] { tag \"Priority\";}";
    doTest(filterScript, "Priority");
  }
  ...
  public void testCountHeaderNumericGE3() {
    ...
    String filterScript =
        "require [\"fileinto\", \"tag\", \"flag\", \"log\", \"relational\","
            + " \"comparator-i;ascii-numeric\"];\n"
            + "if header :count \"ge\" :comparator \"i;ascii-numeric\" [\"to\", \"cc\"] [\"3\"] {"
            + " tag \"Priority\";} else { tag \"No Priority\";}";
    doTest(filterScript, "No Priority");
  }
  ...
  public void testValueAddressNumericGT() {
    ...
    String filterScript =
        "require [\"fileinto\", \"tag\", \"flag\", \"log\", \"relational\","
            + " \"comparator-i;ascii-numeric\"];\n"
            + "if address :value \"gt\" :comparator \"i;ascii-numeric\" [\"to\"] [\"0\"] {tag"
            + " \"Priority\";}";
    doTest(filterScript, "Priority");
  }
  ...
  public void testValueHeaderNumericLE() {
    ...
    String filterScript =
        "require [\"fileinto\", \"tag\", \"flag\", \"log\", \"relational\","
            + " \"comparator-i;ascii-numeric\"];\n"
            + "if header :value \"le\" :comparator \"i;ascii-numeric\" [\"x-priority\"] [\"3\"]"
            + " {tag \"Priority\";}";
    doTest(filterScript, "Priority");
  }
  ...
  public void testValueHeaderNumericEQ() {
    ...
    String filterScript =
        "require [\"fileinto\", \"tag\", \"flag\", \"log\", \"relational\","
            + " \"comparator-i;ascii-numeric\"];\n"
            + "if header :value \"eq\" :comparator \"i;ascii-numeric\" [\"x-priority\"] [\"1\"]"
            + " {tag \"Priority\";}";
    doTest(filterScript, "Priority");
  }
  ...
  public void testValueHeaderNumericNE() {
    ...
    String filterScript =
        "require [\"fileinto\", \"tag\", \"flag\", \"log\", \"relational\","
            + " \"comparator-i;ascii-numeric\"];\n"
            + "if header :value \"ne\" :comparator \"i;ascii-numeric\" [\"x-priority\"] [\"1\"] {"
            + " tag \"Priority\";} else { tag \"No Priority\";}";
    doTest(filterScript, "No Priority");
  }
  ...
  public void testValueEnvelopeCasemap() {
    ...
    String filterScript =
        "require [\"fileinto\", \"tag\", \"flag\", \"log\", \"relational\", \"envelope\"];\n"
  ...
  public void testBadFormat_invalidEnvHeaderName() {
    String filterScript =
        "require [\"envelope\", \"relational\"];"
            ...
            + "tag \"Priority\";} else { tag \"No Priority\";}";
    // The following error will occur:
    // org.apache.jsieve.exception.SyntaxException: Unexpected header name as a value for
    // <envelope-part>: 'AUTH'
    doTest(filterScript, null);
  }
  ...
  public void testValueEnvelopeFromNumeric_AllUpperCase() {
    String filterScript =
        "REQUIRE [\"envelope\", \"relational\", \"tag\", \"comparator-i;ascii-numeric\"];\n"
            + "IF ENVELOPE :COUNT \"EQ\" :COMPARATOR \"I;ASCII-NUMERIC\" "
            + "[\"TO\"] [\"1\"] {"
            + "TAG \"Priority\";}";
    doTest(filterScript, "Priority");
  ...
  public void testValueHeaderNumericNegativeValue() {
    String filterScript =
        "require [\"tag\", \"relational\", \"comparator-i;ascii-numeric\"];\n"
  ...
  public void testValueAddressNumericNegativeValue() {
    String filterScript =
        "require [\"fileinto\", \"tag\", \"flag\", \"log\", \"relational\","
            + " \"comparator-i;ascii-numeric\"];\n"
            + "if address :value \"lt\" :comparator \"i;ascii-numeric\" [\"to\"] [\"-1\"] { tag"
            + " \"to\"; } else { tag \"No To\";}tag \"Negative\";";
    doTest(filterScript, null);
  }
  ...
  public void testValueEnvelopeFromNumericNegativeValue() {
    String filterScript =
        "require [\"fileinto\", \"tag\", \"flag\", \"log\", \"relational\","
            + " \"comparator-i;ascii-numeric\"];\n"
            + "if envelope :value \"lt\" :comparator \"i;ascii-numeric\" [\"from\"] [\"-1\"] { tag"
            + " \"from\"; } else { tag \"No From\";}tag \"Negative\";";
    doTest(filterScript, null);
  }
  ...
  public void testCountHeaderNumericNegativeValue() {
    String filterScript =
        "require [\"fileinto\", \"tag\", \"flag\", \"log\", \"relational\","
            + " \"comparator-i;ascii-numeric\"];\n"
            + "if header :count \"le\" :comparator \"i;ascii-numeric\" [\"received\"] [\"-3\"] {"
            + " tag \"received\";} else { tag \"No Received\";}tag \"Negative\";";
    doTest(filterScript, null);
  }
