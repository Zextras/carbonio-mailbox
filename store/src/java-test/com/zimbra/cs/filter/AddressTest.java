...
public class AddressTest {
  ...
  public void filterValidToField() {
    try {
      ...
      String filterScript =
          "if anyof (address :domain :is :comparator \"i;ascii-casemap\" [\"to\"]"
              + " \"in.telligent.com\",address :domain :is :comparator \"i;ascii-casemap\" [\"to\"]"
      ...
      List<ItemId> ids =
          RuleManager.applyRulesToIncomingMessage(
              ...
              mbox,
              new ParsedMessage("To: test1@in.telligent.com".getBytes(), false),
              0,
              account.getName(),
              new DeliveryContext(),
    ...
    try {
      ...
      List<ItemId> ids =
          RuleManager.applyRulesToIncomingMessage(
              new OperationContext(mbox),
              mbox,
              new ParsedMessage("To: undisclosed-recipients:;".getBytes(), false),
              0,
              account.getName(),
              new DeliveryContext(),
              Mailbox.ID_FOLDER_INBOX,
  ...
  public void testAddressContainingBackslash() {
    try {
      ...
      String filterScript =
          "if address :comparator \"i;ascii-casemap\" :matches \"from\""
              + " \"\\\"user\\\\1\\\"@cosmonaut.zimbra.com\" {  tag \"TestBackslash\";}";
  ...
  public void testAddressContainingDot() {
    try {
      ...
      String filterScript =
          "if address :comparator \"i;ascii-casemap\" :matches \"to\""
              + " \"user.1@cosmonaut.zimbra.com\" {  tag \"TestDot\";}";
  ...
  public void testAddressContainingDoubleQuote() {
    try {
      ...
      String filterScript =
          "if address :comparator \"i;ascii-casemap\" :matches \"to\""
              + " \"\\\"user\\\"1\\\"@cosmonaut.zimbra.com\" {  tag \"TestDoubleQuote\";}";
  ...
  public void testAddressContainingSingleQuote() {
    try {
      ...
      String filterScript =
          "if address :comparator \"i;ascii-casemap\" :matches \"from\""
              + " \"user'1@cosmonaut.zimbra.com\" {  tag \"TestSingleQuote\";}";
  ...
  public void testAddressContainingQuestionMark() {
    try {
      ...
      String filterScript =
          "if address :comparator \"i;ascii-casemap\" :matches \"from\""
              + " \"user?1@cosmonaut.zimbra.com\" {  tag \"TestQuestionMark\";}";

      account.setMailSieveScript(filterScript);
      InputStream is =
          getClass().getResourceAsStream("TestFilter-testQuestionMarkCommaInAddress.msg");
      MimeMessage mm = new ZMimeMessage(JMSession.getSession(), is);
  ...
  public void testAddressContainingComma() {
    try {
      ...
      String filterScript =
          "if address :comparator \"i;ascii-casemap\" :matches \"to\""
              + " \"\\\"user,1\\\"@cosmonaut.zimbra.com\" {  tag \"TestComma\";}";
    ...
    try {
      ...
      List<ItemId> ids =
          RuleManager.applyRulesToIncomingMessage(
              new OperationContext(mbox),
              mbox,
              new ParsedMessage("To: test1@zimbra.com".getBytes(), false),
              0,
              acct.getName(),
              new DeliveryContext(),
              Mailbox.ID_FOLDER_INBOX,
      ...
      Message msg = mbox.getMessageById(null, ids.get(0).getId());
      Assert.assertEquals(
          "compareEmptyStringWithAsciiNumeric", ArrayUtil.getFirstElement(msg.getTags()));
    } catch (Exception e) {
      fail("No exception should be thrown");
    }
  }
  ...
  public void compareHeaderNameWithLeadingSpaces() {
    try {
      ...
      String filterScript =
          "require [\"tag\", \"comparator-i;ascii-numeric\"];\n"
  ...
  public void testDomainIs() {
    ...
    try {
      Provisioning prov = Provisioning.getInstance();
      Account account =
          prov.createAccount("xyz@zimbra.com", "secret", new HashMap<String, Object>());
      ...
      List<ItemId> ids =
          RuleManager.applyRulesToIncomingMessage(
              new OperationContext(mbox),
              mbox,
              new ParsedMessage("To: xyz@zimbra.com".getBytes(), false),
              0,
              account.getName(),
              new DeliveryContext(),
              Mailbox.ID_FOLDER_INBOX,
