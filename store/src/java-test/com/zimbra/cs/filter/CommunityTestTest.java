...
public class CommunityTestTest {
  ...
  public void doRequest(String rule, String headerValue, String tag) throws Exception {
    ...
    List<ItemId> ids =
        RuleManager.applyRulesToIncomingMessage(
            ...
            mbox,
            new ParsedMessage(
                ("From: \"in.Telligent\" <noreply@in.telligent.com>\n"
                        + "X-Zimbra-Community-Notification-Type: "
                        + headerValue
                        + "\n")
                    .getBytes(),
                false),
  ...
  public void testRequestNotifications() throws Exception {
    doRequest(
        "community_requests", "bb196c30-fad3-4ad8-a644-2a0187fc5617", "request notifications");
  }
  ...
  public void testConnectionsNotifications() throws Exception {
    doRequest(
        ...
        "194d3363-f5a8-43b4-a1bd-92a95f6dd76b",
