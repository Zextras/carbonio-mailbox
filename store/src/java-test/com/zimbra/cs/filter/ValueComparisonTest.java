...
public class ValueComparisonTest {
  ...
  /**
   * Tests rule creation through ModifyFilterRulesRequest for header test having caseSensitive
   * attribute with string comparison
   *
   * @throws Exception
   */
  @Test
  public void testHeaderTestStringComparisonCaseSensitivity() throws Exception {
    ...
    String expectedScript =
        "require [\"fileinto\", \"copy\", \"reject\", \"tag\", \"flag\", \"variables\", \"log\","
            + " \"enotify\", \"envelope\", \"body\", \"ereject\", \"reject\", \"relational\","
            + " \"comparator-i;ascii-numeric\"];\n\n";
    expectedScript += "# Test1\n";
    expectedScript +=
        "if anyof (header :contains :comparator \"i;octet\" [\"subject\"] \"Important\") {\n";
  ...
  /**
   * Tests rule creation through ModifyFilterRulesRequest for address test having caseSensitive
   * attribute with string comparison
   *
   * @throws Exception
   */
  ...
  public void testAddressTestStringComparisonCaseSensitivity() throws Exception {
    ...
    expectedScript += "# Test1\n";
    expectedScript +=
        "if anyof (address :all :contains :comparator \"i;octet\" [\"from\"] \"abCD\") {\n";
    expectedScript += "    fileinto \"Junk\";\n";
    expectedScript += "    stop;\n";
    expectedScript += "}\n";
  ...
  /**
   * Tests rule creation through ModifyFilterRulesRequest for envelope test having caseSensitive
   * attribute with string comparison
   *
   * @throws Exception
   */
  ...
  public void testEnvelopeTestStringComparisonCaseSensitivity() throws Exception {
    ...
    expectedScript += "# Test1\n";
    expectedScript +=
        "if anyof (envelope :all :contains :comparator \"i;octet\" [\"from\"] \"abCD\") {\n";
    expectedScript += "    fileinto \"Junk\";\n";
    expectedScript += "    stop;\n";
    expectedScript += "}\n";
  ...
  /**
   * Tests rule creation through ModifyFilterRulesRequest for header test having caseSensitive
   * attribute with value comparison
   *
   * @throws Exception
   */
  @Test
  public void testHeaderTestValueComparisonCaseSensitivity() throws Exception {
    ...
    expectedScript += "# Test1\n";
    expectedScript +=
        "if anyof (header :value \"eq\" :comparator \"i;octet\" [\"subject\"] \"Important\") {\n";
    expectedScript += "    fileinto \"Junk\";\n";
    expectedScript += "    stop;\n";
    expectedScript += "}\n";
  ...
  public void testAddressTestValueComparisonCaseSensitivity() throws Exception {
    ...
    expectedScript += "# Test1\n";
    expectedScript +=
        "if anyof (address :value \"eq\" :all :comparator \"i;octet\" [\"from\"] \"abCD\") {\n";
    expectedScript += "    fileinto \"Junk\";\n";
    expectedScript += "    stop;\n";
    expectedScript += "}\n";
  ...
  public void testEnvelopeTestValueComparisonCaseSensitivity() throws Exception {
    ...
    expectedScript += "# Test1\n";
    expectedScript +=
        "if anyof (envelope :value \"eq\" :all :comparator \"i;octet\" [\"from\"] \"abCD\") {\n";
    expectedScript += "    fileinto \"Junk\";\n";
    expectedScript += "    stop;\n";
    expectedScript += "}\n";
  ...
  /**
   * Tests rule creation through ModifyFilterRulesRequest for header test having value comparison
   * with valueComparisonComparator
   *
   * @throws Exception
   */
  @Test
  ...
  /**
   * Tests rule creation through ModifyFilterRulesRequest for address test having value comparison
   * with valueComparisonComparator
   *
   * @throws Exception
   */
  ...
  /**
   * Tests rule creation through ModifyFilterRulesRequest for envelope test having value comparison
   * with valueComparisonComparator
   *
   * @throws Exception
   */
    ...
    try {
      ...
      String expectedSoapResponse =
          "<GetFilterRulesResponse xmlns=\"urn:zimbraMail\"> \n"
              ...
              + "<headerTest valueComparison=\"eq\" caseSensitive=\"1\" header=\"subject\""
              + " index=\"0\" valueComparisonComparator=\"i;octet\" value=\"Important\"/> \n"
              + "</filterTests> \n"
              + "<filterActions> \n"
    ...
    try {
      ...
      String expectedSoapResponse =
          "<GetFilterRulesResponse xmlns=\"urn:zimbraMail\"> \n"
              ...
              + "<filterRule active=\"1\"> \n"
              + "<filterTests condition=\"anyof\"> \n"
              + "<addressTest valueComparison=\"eq\" caseSensitive=\"1\" part=\"all\""
              + " header=\"from\" index=\"0\" valueComparisonComparator=\"i;octet\""
              + " value=\"abCD\"/> \n"
              + "</filterTests> \n"
              + "<filterActions> \n"
              + " <actionFileInto folderPath=\"Junk\" index=\"0\" copy=\"0\"/> \n"
    ...
    try {
      ...
      String expectedSoapResponse =
          "<GetFilterRulesResponse xmlns=\"urn:zimbraMail\"> \n"
              ...
              + "<filterRule active=\"1\"> \n"
              + "<filterTests condition=\"anyof\"> \n"
              + "<envelopeTest valueComparison=\"eq\" caseSensitive=\"1\" part=\"all\""
              + " header=\"from\" index=\"0\" valueComparisonComparator=\"i;octet\""
              + " value=\"abCD\"/> \n"
              + "</filterTests> \n"
              + "<filterActions> \n"
