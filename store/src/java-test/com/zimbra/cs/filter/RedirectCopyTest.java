...
public class RedirectCopyTest {
  ...
  public void testPlainRedirect() {
    String filterPlainRedirectScript =
        "require [\"redirect\"];\n"
  ...
  public void testCopyRedirectThenFileInto() {
    ...
    try {
      ...
      RuleManager.applyRulesToIncomingMessage(
          new OperationContext(mbox),
          mbox,
          new ParsedMessage(rawReal.getBytes(), false),
          0,
          account.getName(),
          new DeliveryContext(),
          Mailbox.ID_FOLDER_INBOX,
  ...
  public void testPlainRedirectMimeMsg1() {
    ...
    try {
      Account account2 = Provisioning.getInstance().get(Key.AccountBy.name, "test2@zimbra.com");
      Account account3 = Provisioning.getInstance().get(Key.AccountBy.name, "test3@zimbra.com");
      ...
      String rawReal =
          "From: test1@zimbra.com\n" + "To: test2@zimbra.com\n" + "Subject: Test\n" + "\n" + body;
      RuleManager.applyRulesToIncomingMessage(
          new OperationContext(mbox2),
          mbox2,
          new ParsedMessage(rawReal.getBytes("Shift_JIS"), false),
          0,
          account2.getName(),
          new DeliveryContext(),
          Mailbox.ID_FOLDER_INBOX,
      ...
      Integer item =
          mbox3.getItemIds(null, Mailbox.ID_FOLDER_INBOX).getIds(MailItem.Type.MESSAGE).get(0);
