...
public class DeleteHeaderTest {
    ...
    try {
      String filterScript =
          "require [\"editheader\", \"relational\", \"comparator-i;ascii-numeric\"];\n"
              + " deleteheader :value \"lt\" :comparator \"i;ascii-numeric\" \"X-Numeric-Header\""
              + " \"3\" \r\n"
              + "  ;\n";
      Account acct1 = Provisioning.getInstance().get(Key.AccountBy.name, "test@zimbra.com");
      Mailbox mbox1 = MailboxManager.getInstance().getMailboxByAccount(acct1);
  ...
  public void testDeleteHeaderWithNumericComparisionUsingCount() {
    try {
      String filterScript =
          "require [\"editheader\", \"relational\", \"comparator-i;ascii-numeric\"];\n"
              + " deleteheader :count \"ge\" :comparator \"i;ascii-numeric\" \"X-Numeric-Header\""
              + " \"3\" \r\n"
              + "  ;\n";
      Account acct1 = Provisioning.getInstance().get(Key.AccountBy.name, "test@zimbra.com");
      Mailbox mbox1 = MailboxManager.getInstance().getMailboxByAccount(acct1);
  ...
  public void testDeleteHeaderUsingMatchesNonASCII() {
    try {
      String filterScript =
          "require [\"editheader\"];\n"
              + "deleteheader :comparator \"i;ascii-casemap\" :is  \"X-Test-Header-non-ascii\""
              + " \"日本語の件名\";\n";
      Account acct1 = Provisioning.getInstance().get(Key.AccountBy.name, "test@zimbra.com");
      Mailbox mbox1 = MailboxManager.getInstance().getMailboxByAccount(acct1);
    ...
    try {
      String filterScript =
          "require [\"editheader\", \"relational\"];\n"
              + " deleteheader :value \"lt\" :comparator \"i;ascii-casemap\" \"X-Numeric-Header\""
              + " \"3\" \r\n"
              + "  ;\n";
      Account acct1 = Provisioning.getInstance().get(Key.AccountBy.name, "test@zimbra.com");
      Mailbox mbox1 = MailboxManager.getInstance().getMailboxByAccount(acct1);
  ...
  public void testDeleteHeaderWithOutMatchType() {
    try {
      ...
      for (Enumeration<Header> enumeration = message.getMimeMessage().getAllHeaders();
        ...
        Header header = enumeration.nextElement();
        if ("X-Numeric-Header".equals(header.getName())
            && Integer.valueOf(header.getValue()) == 3) {
          matchFound = true;
          break;
        }
      }
  ...
  public void testDeleteHeaderCountNegative() {
    try {
      String filterScript =
          "require [\"editheader\", \"relational\", \"comparator-i;ascii-numeric\"];\n"
              + "deleteheader :count \"le\" :comparator \"i;ascii-numeric\" \"X-Numeric-Header\""
              + " \"-1\";\n";
      Account acct1 = Provisioning.getInstance().get(Key.AccountBy.name, "test@zimbra.com");
      Mailbox mbox1 = MailboxManager.getInstance().getMailboxByAccount(acct1);
    ...
    try {
      ...
      List<ItemId> ids =
          RuleManager.applyRulesToIncomingMessage(
              new OperationContext(mbox),
              mbox,
              new ParsedMessage("X-Header: example".getBytes(), false),
              0,
              account.getName(),
              new DeliveryContext(),
              Mailbox.ID_FOLDER_INBOX,
  ...
  public void testBackslashAsciiCasemap4bs() throws Exception {
    ...
    String script =
        "require [\"editheader\"];\n"
            + "deleteheader :comparator \"i;ascii-casemap\" \"X-Header\" "
            + " \"Sample\\\\\\\\\\\\\\\\Pattern\";deleteheader :comparator \"i;ascii-casemap\""
            + " \"X-HeaderA\" \"Sample\\\\\\\\Pattern\";deleteheader :comparator"
            + " \"i;ascii-casemap\" \"X-HeaderB\" \"Sample\\\\Pattern\";deleteheader :comparator"
  ...
  public void testBackslashOctet() throws Exception {
    String script =
        "require [\"editheader\"];\n"
            + "deleteheader :comparator \"i;octet\" \"X-Header\" "
            + " \"Sample\\\\\\\\\\\\\\\\Pattern\";deleteheader :comparator \"i;octet\""
            + " \"X-HeaderA\" \"Sample\\\\\\\\Pattern\";deleteheader :comparator \"i;octet\""
            + " \"X-HeaderB\" \"Sample\\\\Pattern\";deleteheader :comparator \"i;octet\""
