...
public class FilterUtilTest {
  ...
  public void truncateBody() throws Exception {
    ...
    Assert.assertTrue(
        "truncated body should not have a partial char at the end", "Andr".equals(body));
  }
  ...
  public void noBody() throws Exception {
    ...
    Map<String, String> vars =
        FilterUtil.getVarsMap(mbox, parsedMessage, parsedMessage.getMimeMessage());
  }
    ...
    try {
      ...
      varValue =
          FilterUtil.replaceVariables(
              mailAdapter, "You've got a mail. ${a_b} ${combination} ${c_d}hao!");
      Assert.assertEquals(
          "You've got a mail. \u304a\u3057\u3089\u305b Hello ACME!! Chao!", varValue);
    } catch (Exception e) {
