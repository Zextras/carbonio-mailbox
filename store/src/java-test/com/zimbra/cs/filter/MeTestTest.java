  ...
  public void meInTo() throws Exception {
    ...
    List<ItemId> ids =
        RuleManager.applyRulesToIncomingMessage(
            ...
            mbox,
            new ParsedMessage("To: test@zimbra.com".getBytes(), false),
            0,
            account.getName(),
            new DeliveryContext(),
  ...
  public void meInToMultiRecipient() throws Exception {
    ...
    List<ItemId> ids =
        RuleManager.applyRulesToIncomingMessage(
            ...
            mbox,
            new ParsedMessage(
                "To: foo@zimbra.com, test@zimbra.com, bar@zimbra.com".getBytes(), false),
            0,
            account.getName(),
            new DeliveryContext(),
            Mailbox.ID_FOLDER_INBOX,
  ...
  public void quotedMultiRecipientTo() throws Exception {
    ...
    List<ItemId> ids =
        RuleManager.applyRulesToIncomingMessage(
            ...
            mbox,
            new ParsedMessage(
                "To: \"bar, foo\" <foo@zimbra.com>, \"user, test\" <test@zimbra.com>, \"aaa bbb\" <aaabbb@test.com>"
                    .getBytes(),
                false),
            0,
            account.getName(),
  ...
  public void meInToOrCc() throws Exception {
    ...
    ids =
        RuleManager.applyRulesToIncomingMessage(
            new OperationContext(mbox),
            mbox,
            new ParsedMessage("Cc: test@zimbra.com".getBytes(), false),
            0,
            account.getName(),
            new DeliveryContext(),
            Mailbox.ID_FOLDER_INBOX,
  ...
  public void meInToOrCcMultiRecipient() throws Exception {
    ...
    List<ItemId> ids =
        RuleManager.applyRulesToIncomingMessage(
            new OperationContext(mbox),
            mbox,
            new ParsedMessage("To: foo@zimbra.com, test@zimbra.com".getBytes(), false),
            0,
            account.getName(),
            new DeliveryContext(),
            Mailbox.ID_FOLDER_INBOX,
    ...
    ids =
        RuleManager.applyRulesToIncomingMessage(
            new OperationContext(mbox),
            mbox,
            new ParsedMessage("Cc: foo@zimbra.com, test@zimbra.com".getBytes(), false),
            0,
            account.getName(),
            new DeliveryContext(),
            Mailbox.ID_FOLDER_INBOX,
  ...
  public void quotedMultiRecipientToOrCc() throws Exception {
    ...
    List<ItemId> ids =
        RuleManager.applyRulesToIncomingMessage(
            ...
            mbox,
            new ParsedMessage(
                "To: \"bar, foo\" <foo@zimbra.com>, \"test user\" <test@zimbra.com>".getBytes(),
                false),
            0,
            account.getName(),
            new DeliveryContext(),
    ...
    ids =
        RuleManager.applyRulesToIncomingMessage(
            ...
            mbox,
            new ParsedMessage(
                "Cc: \"foo bar\" <foo@zimbra.com>, \"user, test\" <test@zimbra.com>".getBytes(),
                false),
            0,
            account.getName(),
            new DeliveryContext(),
