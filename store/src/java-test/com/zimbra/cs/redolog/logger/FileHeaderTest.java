...
public class FileHeaderTest {
  ...
  public void uninitializedHeader() throws Exception {
    ...
    Assert.assertEquals("header from file should match serialized data", hdr, fromFile);
  }
  ...
  public void junkFile() throws Exception {
    ...
    hdr = new FileHeader();
    assertThrows(IOException.class, () -> hdr.read(raFile));
  }
  ...
  public void versionTooHigh() throws Exception {
    ...
    try {
      ...
      Assert.assertTrue(
          ...
          e.getMessage().contains("is higher than the highest known version"));
      return;
    }
