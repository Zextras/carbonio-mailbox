...
public class AbortTxnTest {
  ...
  public void setUp() {
    changeEntry =
        EasyMock.createMockBuilder(CopyItem.class)
            ...
            .createMock();
    EasyMock.expect(changeEntry.getTransactionId()).andStubReturn(new TransactionId(1, 2));
  ...
  public void testDefaultConstructor() {
    op = new AbortTxn();
    Assert.assertNull("TransactionId is set on new op.", op.getTransactionId());
  }
  ...
  public void testOpConstructor() {
    ...
    Assert.assertEquals("Transactionid != 1, 2", new TransactionId(1, 2), op.getTransactionId());
  ...
  public void serializeDeserialize() throws Exception {
    ...
    Assert.assertEquals(
        "opcode should be CopyItem after deserialize.",
        MailboxOperation.CopyItem,
        op.getTxnOpCode());
  }
}
