...
public class TransactionIdTest {
  ...
  public void stringEncodeDecode() throws Exception {
    ...
    Assert.assertEquals("mismatch on decode.", id, TransactionId.decodeFromString(encoded));
  }

  @Test
  public void stringBadDecode() throws Exception {
    assertThrows(ServiceException.class, () -> TransactionId.decodeFromString("not-valid"));
  }
  ...
  public void streamEncodeDecode() throws Exception {
    ...
    RedoLogInput redoIn = new RedoLogInput(new ByteArrayInputStream(os.toByteArray()));
