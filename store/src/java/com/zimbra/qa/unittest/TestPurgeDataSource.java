...
public class TestPurgeDataSource extends TestCase {
  ...
  private void setPurgeParams(boolean purgeEnabled, long dsQuota, long totalQuota)
      throws Exception {
    Map<String, Object> attrs = new HashMap<String, Object>();
    attrs.put(
        Provisioning.A_zimbraFeatureDataSourcePurgingEnabled,
        purgeEnabled ? ProvisioningConstants.TRUE : ProvisioningConstants.FALSE);
  ...
  private void setThreadingAlgorithm(String algorithm)
  ...
  private String getBody() {
    return "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis euismod in dui vitae"
        + " mollis. Vivamus ac tortor mattis, vestibulum neque auctor, scelerisque justo."
        + " Vestibulum fermentum tortor non nunc rutrum viverra. Integer quis mauris"
        + " ullamcorper lacus interdum aliquam vel rhoncus enim. Quisque suscipit interdum"
        + " ex, non mattis massa euismod non. Sed semper, odio ac condimentum aliquet, metus"
        + " arcu dictum nisl, vel rhoncus neque elit quis sem. Integer non eleifend felis."
        + " Aliquam lacus quam, semper sed nulla ac, dapibus iaculis justo. Pellentesque"
        + " dapibus, ligula et sollicitudin interdum, sapien libero porttitor ipsum, ut"
        + " consectetur justo neque sed augue. Integer volutpat vestibulum nisl, et maximus"
        + " mauris mattis eget. In ullamcorper dui eget quam efficitur imperdiet. Phasellus"
        + " sit amet sem est.\n"
        + "Proin tincidunt, metus eget egestas venenatis, urna sem imperdiet justo, et"
        + " elementum dolor nibh hendrerit augue. Sed a lobortis enim. In mattis felis orci,"
        + " quis gravida eros maximus non. Suspendisse iaculis libero tempus, vestibulum"
        + " mauris quis, tempor neque. Pellentesque rhoncus sollicitudin leo, sed auctor"
        + " nunc mattis et. Fusce laoreet placerat nunc, ac tempus diam sollicitudin"
        + " vulputate. Praesent imperdiet auctor turpis, sit amet consequat quam venenatis"
        + " non. Aenean eget porta dui, et maximus nibh. In hac habitasse platea dictumst."
        + " Aliquam mi erat, scelerisque at ipsum vitae, bibendum tincidunt quam. Fusce non"
        + " ante diam. Interdum et malesuada fames ac ante ipsum primis in faucibus. Vivamus"
        + " ac mauris rhoncus, mattis massa et, congue elit. Etiam sagittis scelerisque"
        + " tristique. Vivamus blandit non est et sagittis. Vestibulum feugiat nec diam quis"
        + " iaculis.\n"
        + "Donec dolor justo, imperdiet et commodo ac, commodo non dui. Ut in pretium augue,"
        + " dictum finibus augue. Aenean est massa, luctus et hendrerit sit amet, varius id"
        + " augue. Aliquam erat volutpat. Maecenas sed odio eu nunc ullamcorper rutrum."
        + " Proin et accumsan neque. Quisque accumsan augue nec nisi euismod, ac cursus"
        + " tortor posuere.";
  }
