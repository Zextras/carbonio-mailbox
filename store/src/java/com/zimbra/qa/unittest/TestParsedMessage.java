...
public class TestParsedMessage {
  ...
  /**
   * Confirms that the digest returned by a <tt>ParsedMessage</tt> is the same, regardless of
   * whether the source comes from a byte array, file or <tt>MimeMessage</tt>.
   */
  @Test
  public void testGetData() throws Exception {
    String msg =
        TestUtil.getTestMessage(NAME_PREFIX + " testGetData", SENDER_NAME, SENDER_NAME, null);
