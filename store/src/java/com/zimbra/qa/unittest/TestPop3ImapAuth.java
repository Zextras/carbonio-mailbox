...
public final class TestPop3ImapAuth {
  ...
  private static final String IMAP_ID =
      "4 ID (\"X-ORIGINATING-IP\" \"100.99.98.97\" \"name\" \"foobar\" \"version\" \"1.0\")" + CRLF;
  ...
  private void setUpStrings() {
    USER_NAME =
        String.format(
                "%s-%s-user1", TestPop3ImapAuth.class.getSimpleName(), testInfo.getMethodName())
            .toLowerCase();
  ...
  public void setUp() throws Exception {
    ...
    mOrigPop3CleartextLoginEnabled =
        server.getBooleanAttr(Provisioning.A_zimbraPop3CleartextLoginEnabled, false);
    mOrigImapCleartextLoginEnabled =
        server.getBooleanAttr(Provisioning.A_zimbraImapCleartextLoginEnabled, false);
