...
public class TestDomainAdmin extends TestCase {
  ...
  private static final String DOMADMIN = "domadmin@" + ADMINISTRATOR_DOMAIN;
  private static final String TARGET_ACCT = "targetacct@" + ADMINISTERED_DOMAIN;
  private static final String TARGET_ACCT_RENAMED = "targetacctrenamed@" + ADMINISTERED_DOMAIN;
  private static final String TARGET_ACCT2 = "targetacct2@" + ADMINISTERED_DOMAIN;
  private static final String TARGET_CALRES = "targetroom@" + ADMINISTERED_DOMAIN;
  private static final String TARGET_CALRES2 = "targetroom2@" + ADMINISTERED_DOMAIN;
  private static final String TARGET_CALRES_RENAMED = "targetroomrenamed@" + ADMINISTERED_DOMAIN;
  private static final String DOMADMINGROUP = "domadmingroup@" + ADMINISTERED_DOMAIN;
  private static final String TARGET_DL = "targetdl@" + ADMINISTERED_DOMAIN;
  private static final String TARGET_DL2 = "targetdl2@" + ADMINISTERED_DOMAIN;
  private static final String TARGET_DL_RENAMED = "targetdlrenamed@" + ADMINISTERED_DOMAIN;
  private static final String DIFF_ACCT = "diffacct@" + DIFFERENT_DOMAIN;
  private static final String DIFF_ACCT2 = "diffacct2@" + DIFFERENT_DOMAIN;
  private static final String DIFF_CALRES = "diffroom@" + DIFFERENT_DOMAIN;
  private static final String DIFF_CALRES2 = "diffroom2@" + DIFFERENT_DOMAIN;
  private static final String DIFF_DL = "diffdl@" + DIFFERENT_DOMAIN;
  private static final String DIFF_DL2 = "diffdl2@" + DIFFERENT_DOMAIN;
  private static final String ALIAS_FOR_TARGET_DL = "alias_4_targetdl@" + ADMINISTERED_DOMAIN;
  private static final String ALIAS_FOR_TARGET_ACCT = "alias_4_targetacct@" + ADMINISTERED_DOMAIN;
  private static final String ALIAS_FOR_TARGET_ACCT2 = "alias_4_targetacct2@" + ADMINISTERED_DOMAIN;
  ...
  public String createAdminConsoleStyleDomainAdminGroup(String domAdminGrp)
      throws ServiceException {
    ...
    ModifyDistributionListResponse mdlResp =
        adminSoapProv.invokeJaxb(new ModifyDistributionListRequest(cdlResp.getDl().getId(), attrs));
  ...
  public String createAdminConsoleStyleDomainAdmin(String domAdminName) throws ServiceException {
    ...
    attrs.add(new Attr(Provisioning.A_zimbraAdminConsoleUIComponents, "resourceListView"));
    attrs.add(new Attr(Provisioning.A_zimbraAdminConsoleUIComponents, "saveSearch"));
    CreateAccountRequest caReq =
        new CreateAccountRequest(domAdminName, TestUtil.DEFAULT_PASSWORD, attrs);
  ...
  public static SoapProvisioning getSoapProvisioning(String account, String password)
      throws ServiceException {
  ...
  public static void checkSoapReason(SoapFaultException sfe, String expectedSubstring) {
    ...
    assertTrue(
        "SoapFault reason '" + soapReason + "' should contain '" + expectedSubstring + "'",
  ...
  public void testDelegatedAdminAssignSendToDistList() throws Exception {
    ...
    assertNotNull(
        "CreateDistributionListResponse for " + TARGET_DL + " simple as domAdmin", caResp);
    ...
    grantRight(
        domAdminSoapProv, TargetType.dl, TARGET_DL, TARGET_ACCT, RightConsts.RT_sendToDistList);
  ...
  public void testDelegatedAdminAssignSendAs() throws Exception {
    ...
    grantRight(
        domAdminSoapProv, TargetType.account, TARGET_ACCT2, TARGET_ACCT, RightConsts.RT_sendAs);
  ...
  public void testViaGroupDelegatedAdminAssignSendToDistList() throws Exception {
    ...
    attrs.add(new Attr(Provisioning.A_zimbraIsDelegatedAdminAccount, "TRUE"));
    CreateAccountRequest caReq =
        new CreateAccountRequest(DOMADMIN, TestUtil.DEFAULT_PASSWORD, attrs);
    ...
    assertNotNull(
        "CreateDistributionListResponse for " + TARGET_DL + " simple as domAdmin", cdlResp);
  ...
  public void testGetAccountInDomAdminDomain() throws Exception {
    ...
    CreateAccountResponse caResp;
    caResp =
        domAdminSoapProv.invokeJaxb(
            new CreateAccountRequest(TARGET_ACCT, TestUtil.DEFAULT_PASSWORD));
    assertNotNull("CreateAccountResponse for " + TARGET_ACCT + " simple as domAdmin", caResp);
    String acctId = caResp.getAccount().getId();

    GetAccountRequest getAcctReq =
        new GetAccountRequest(AccountSelector.fromName(TARGET_ACCT), true /*applyCos*/);
    ...
    assertNotNull(
        "GetAccountResponse for " + TARGET_ACCT + " as domAdmin specifying target acct",
        getAcctResp);
    ...
    assertNotNull(
        "GetMailboxResponse for " + TARGET_ACCT + " as domAdmin specifying target acct", gmResp);

    AddAccountAliasResponse aaaResp;
    aaaResp =
        domAdminSoapProv.invokeJaxb(new AddAccountAliasRequest(acctId, ALIAS_FOR_TARGET_ACCT));
    assertNotNull("AddAccountAliasResponse for " + TARGET_ACCT + " simple as domAdmin", aaaResp);
    aaaResp =
        domAdminSoapProv.invokeJaxbOnTargetAccount(
            new AddAccountAliasRequest(acctId, ALIAS_FOR_TARGET_ACCT2), acctId);
    assertNotNull(
        "AddAccountAliasResponse for " + TARGET_ACCT + " as domAdmin specifying target acct",
        aaaResp);
    ...
    assertNotNull(
        "RemoveAccountAliasResponse for " + TARGET_ACCT + " as domAdmin specifying target acct",
        daaResp);
    ...
    assertNotNull(
        "RenameAccountResponse for " + TARGET_ACCT + " as domAdmin specifying target acct",
        renAResp);
    ...
    delAcctResp = domAdminSoapProv.invokeJaxbOnTargetAccount(delAcctReq, acctId);
    assertNotNull(
        "DeleteAccountResponse for " + TARGET_ACCT + " as domAdmin specifying target acct",
        delAcctResp);
    try {
  ...
  public void testGetAccountInDiffDomain() throws Exception {
    ...
    SoapProvisioning domAdminSoapProv = getSoapProvisioning(DOMADMIN, TestUtil.DEFAULT_PASSWORD);
    GetAccountRequest getAcctReq =
        new GetAccountRequest(AccountSelector.fromName(DIFF_ACCT), true /*applyCos*/);
    try {
  ...
  public void testModifyAccountInDomAdminDomain() throws Exception {
    ...
    assertNotNull(
        "ModifyAccountResponse for " + TARGET_ACCT + " as domAdmin specifying target acct",
        modAcctResp);
    ...
    try {
      ...
      // Get this instead of "no such account: " because modify by ID (not name) and for domain
      // admin
  ...
  public void testModifyAccountInDiffDomain() throws Exception {
    ...
    assertNotNull(
        "DeleteAccountResponse for " + DIFF_ACCT + " as ADMIN specifying target acct", delAcctResp);
    try {
      domAdminSoapProv.invokeJaxb(modAcctReq);
      fail("ModifyAccountRequest succeeded after delete!");
    } catch (SoapFaultException sfe) {
  ...
  public void testGetCalendarResourceInDomAdminDomain() throws Exception {
    ...
    List<Attr> attrs = Lists.newArrayList();
    attrs.add(
        new Attr(Provisioning.A_displayName, "testGetCalendarResourceInDomAdminDomain Room 101"));
    ...
    assertNotNull(
        "CreateCalendarResourceResponse for " + TARGET_CALRES + " simple as domAdmin", caResp);
    String acctId = caResp.getCalResource().getId();

    GetCalendarResourceResponse getAcctResp =
        domAdminSoapProv.invokeJaxb(
            new GetCalendarResourceRequest(
                CalendarResourceSelector.fromName(TARGET_CALRES), true /*applyCos*/));
    assertNotNull(
        "GetCalendarResourceResponse for " + TARGET_CALRES + " simple as domAdmin", getAcctResp);
    getAcctResp =
        domAdminSoapProv.invokeJaxbOnTargetAccount(
            new GetCalendarResourceRequest(
                CalendarResourceSelector.fromName(TARGET_CALRES), true /*applyCos*/),
            acctId);
    assertNotNull(
        "GetCalendarResourceResponse for " + TARGET_CALRES + " as domAdmin specifying target acct",
        getAcctResp);

    RenameCalendarResourceResponse renAResp;
    renAResp =
        domAdminSoapProv.invokeJaxb(
            new RenameCalendarResourceRequest(acctId, TARGET_CALRES_RENAMED));
    assertNotNull(
        "RenameCalendarResourceResponse for " + TARGET_CALRES + " simple as domAdmin", renAResp);

    renAResp =
        domAdminSoapProv.invokeJaxb(new RenameCalendarResourceRequest(acctId, TARGET_CALRES));
    assertNotNull(
        "RenameCalendarResourceResponse for "
            + TARGET_CALRES
            + " as domAdmin specifying target acct",
        renAResp);
    ...
    delAcctResp = domAdminSoapProv.invokeJaxbOnTargetAccount(delAcctReq, acctId);
    assertNotNull(
        "DeleteCalendarResourceResponse for "
            + TARGET_CALRES
            + " as domAdmin specifying target acct",
        delAcctResp);
    try {
    ...
    try {
      getAcctResp =
          domAdminSoapProv.invokeJaxb(
              new GetCalendarResourceRequest(
                  CalendarResourceSelector.fromId(acctId), true /*applyCos*/));
      fail("GetCalendarResourceRequest succeeded after delete!");
    } catch (SoapFaultException sfe) {
      checkSoapReason(
          sfe, "permission denied: can not access calendar resource "); // because by id not name
    }
    try {
      getAcctResp =
          domAdminSoapProv.invokeJaxbOnTargetAccount(
  ...
  public void testGetCalendarResourceInDiffDomain() throws Exception {
    ...
    caResp =
        adminSoapProv.invokeJaxb(
            new CreateCalendarResourceRequest(DIFF_CALRES, TestUtil.DEFAULT_PASSWORD, attrs));
    assertNotNull(
        "CreateCalendarResourceResponse for " + DIFF_CALRES + " simple as domAdmin", caResp);
    String acctId = caResp.getCalResource().getId();

    GetCalendarResourceRequest getAcctReq =
        new GetCalendarResourceRequest(
            CalendarResourceSelector.fromName(DIFF_CALRES), true /*applyCos*/);
    try {
      domAdminSoapProv.invokeJaxb(getAcctReq);
    ...
    getAcctReq =
        new GetCalendarResourceRequest(
            CalendarResourceSelector.fromName(DIFF_CALRES2), true /*applyCos*/);
    try {
      domAdminSoapProv.invokeJaxb(getAcctReq);
  ...
  public void testModifyCalendarResourceInDomAdminDomain() throws Exception {
    ...
    attrs.add(
        new Attr(
            Provisioning.A_displayName, "testModifyCalendarResourceInDomAdminDomain Room 101"));
    attrs.add(new Attr(Provisioning.A_description, "Room 101 for 50 seats"));
    attrs.add(new Attr(Provisioning.A_zimbraCalResType, "Location"));
    attrs.add(new Attr(Provisioning.A_zimbraCalResAutoAcceptDecline, "TRUE"));
    attrs.add(new Attr(Provisioning.A_zimbraCalResAutoDeclineIfBusy, "TRUE"));
    ...
    modAcctResp = domAdminSoapProv.invokeJaxb(modAcctReq);
    assertNotNull(
        "ModifyCalendarResourceResponse for " + TARGET_CALRES2 + " simple as domAdmin",
        modAcctResp);
    modAcctReq = new ModifyCalendarResourceRequest(acctId);
    modAcctReq.addAttr(new Attr(Provisioning.A_description, "another dummy description"));
    modAcctResp = domAdminSoapProv.invokeJaxbOnTargetAccount(modAcctReq, acctId);
    assertNotNull(
        "ModifyCalendarResourceResponse for "
            + TARGET_CALRES2
            + " as domAdmin specifying target acct",
        modAcctResp);
    ...
    try {
      ...
      // Get this instead of "no such calendar resource: " because modify by ID (not name) and for
      // domain admin
      // cannot know whether that ID was for a domain we administered or not.
      checkSoapReason(sfe, "permission denied: can not access calendar resource ");
    }
  ...
  public void testModifyCalendarResourceInDiffDomain() throws Exception {
    ...
    List<Attr> attrs = Lists.newArrayList();
    attrs.add(
        new Attr(Provisioning.A_displayName, "testModifyCalendarResourceInDiffDomain Room 101"));
    attrs.add(new Attr(Provisioning.A_description, "Room 101 for 50 seats"));
    attrs.add(new Attr(Provisioning.A_zimbraCalResType, "Location"));
    attrs.add(new Attr(Provisioning.A_zimbraCalResAutoAcceptDecline, "TRUE"));
    attrs.add(new Attr(Provisioning.A_zimbraCalResAutoDeclineIfBusy, "TRUE"));
    ...
    DeleteCalendarResourceRequest delAcctReq = new DeleteCalendarResourceRequest(acctId);
    DeleteCalendarResourceResponse delAcctResp =
        adminSoapProv.invokeJaxbOnTargetAccount(delAcctReq, acctId);
    assertNotNull(
        "DeleteCalendarResourceResponse for " + DIFF_CALRES + " as ADMIN specifying target acct",
        delAcctResp);
    try {
      domAdminSoapProv.invokeJaxb(modAcctReq);
      fail("ModifyCalendarResourceRequest succeeded after delete!");
  ...
  public void testGetDistributionListInDomAdminDomain() throws Exception {
    ...
    assertNotNull(
        "GetDistributionListResponse for " + TARGET_DL + " simple as domAdmin", getDlResp);

    AddDistributionListAliasResponse aaaResp;
    aaaResp =
        domAdminSoapProv.invokeJaxb(new AddDistributionListAliasRequest(dlId, ALIAS_FOR_TARGET_DL));
    assertNotNull(
        "AddDistributionListAliasResponse for " + TARGET_DL + " simple as domAdmin", aaaResp);

    RemoveDistributionListAliasResponse daaResp;
    daaResp =
        domAdminSoapProv.invokeJaxb(
            new RemoveDistributionListAliasRequest(dlId, ALIAS_FOR_TARGET_DL));
    assertNotNull(
        "RemoveDistributionListAliasResponse for " + TARGET_DL + " simple as domAdmin", daaResp);
    ...
    assertNotNull(
        "RenameDistributionListResponse for " + TARGET_DL + " simple as domAdmin", renAResp);
    ...
    try {
      ...
      checkSoapReason(
          sfe, "permission denied: can not access distribution list"); // because by id not name
    }
  }
  ...
  public void testGetDistributionListInDiffDomain() throws Exception {
    ...
    try {
      domAdminSoapProv.invokeJaxb(getAcctReq);
      fail(
          "GetDistributionListRequest succeeded for non-existent DistributionList in other"
              + " domain!");
    } catch (SoapFaultException sfe) {
      checkSoapReason(sfe, "permission denied: can not access distribution list");
    }
    ...
    try {
      aaaResp =
          domAdminSoapProv.invokeJaxb(
              new AddDistributionListAliasRequest(dlId, ALIAS_FOR_TARGET_DL));
    ...
    aaaResp =
        adminSoapProv.invokeJaxb(new AddDistributionListAliasRequest(dlId, ALIAS_FOR_TARGET_DL));
  ...
  public void testModifyDistributionListInDomAdminDomain() throws Exception {
    ...
    modDlResp = domAdminSoapProv.invokeJaxb(modDlReq);
    assertNotNull(
        "ModifyDistributionListResponse for " + TARGET_DL2 + " simple as domAdmin", modDlResp);
  ...
  public void testModifyDistributionListInDiffDomain() throws Exception {
    ...
    try {
      ...
      // Get this instead of "no such distribution list" because modify by ID (not name) and for
      // domain admin
      // cannot know whether that ID was for a domain we administered or not.
      checkSoapReason(sfe, "permission denied: can not access distribution list ");
    }
