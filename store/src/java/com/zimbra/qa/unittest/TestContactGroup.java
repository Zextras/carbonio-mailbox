...
public class TestContactGroup {
  ...
  public void derefContact() throws Exception {
    ...
    Contact contact =
        mbox.createContact(octxt, new ParsedContact(fields), Mailbox.ID_FOLDER_CONTACTS, null);
  ...
  public void derefGal() throws Exception {
    ...
    Account galMember =
        Provisioning.getInstance().get(AccountBy.name, TestUtil.getAddress("user2"));
  ...
  public void replaceMembersWithDlist() throws Exception {
    ...
    String dlist =
        "\"Ballard, Martha\" <martha34@aol.com>, \"Davidson, Ross\" <rossd@example.zimbra.com>,"
            + " user1@test.com";
  ...
  public void returnMembersAsDlist() throws Exception {
    ...
    assertEquals(
        "test1@zimbra.com, test2@zimbra.com, " + galEntryEmail + ", aaa@test.com, zzz@test.com",
        dlist);
  }
