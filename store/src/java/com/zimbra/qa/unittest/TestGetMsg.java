...
public class TestGetMsg {
  ...
  public void testHtmlMessageContent() throws Exception {
    doTestMessageContent(
        MimeConstants.CT_TEXT_HTML, "<html><head></head><body>HTML message</body></html>");
  }

  @Test
  public void testEnrichedMessageContent() throws Exception {
    doTestMessageContent(
        MimeConstants.CT_TEXT_ENRICHED,
        "<color><param>red</param>Blood</color> is <bold>thicker</bold>"
            + " than<color><param>blue</param>water</color>.");
  }
