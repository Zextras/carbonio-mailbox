...
public class TestFileUpload {
  ...
  public void testAdminUploadWithCsrfInHeader() throws Exception {
    ...
    builder.addBinaryBody(
        FILE_NAME, "some file content".getBytes(), ContentType.create(contentType), FILE_NAME);
  ...
  /**
   * Confirms that <tt>requestId</tt> parameter values are restricted as desired. See bug 99914 and
   * bug 40377.
   *
   * @throws Exception
   */
  ...
  public void testRequestIdScript() throws Exception {
    ...
    Assert.assertFalse(
        "Response does not contain 'script': " + responseContent,
  ...
  public void testRequestIdAlert() throws Exception {
    ...
    Assert.assertFalse(
        "Response does not contain 'alert': " + responseContent, responseContent.contains("alert"));
    Assert.assertTrue(responseContent, responseContent.startsWith("400,"));
  }
  ...
  private String postAndVerify(
      ZMailbox mbox, URI uri, boolean clearCookies, String requestId, String attContent)
      throws IOException, HttpException {
