...
public class TestSpellCheck {
  ...
  public void testIgnore() throws Exception {
    CheckSpellingResponse result =
        mbox.checkSpelling("one twi thre forr", null, Arrays.asList("twi", "thre"));
  ...
  private boolean hasSuggestion(
      CheckSpellingResponse result, String misspelled, String expectedSuggestion) {
    for (Misspelling mis : result.getMisspelledWords()) {
  ...
  /**
   * Confirms that <tt>GetSpellDictionaries</tt> returns the current list of dictionaries from
   * <tt>zimbraSpellAvailableDictionary</tt>.
   */
  @Test
