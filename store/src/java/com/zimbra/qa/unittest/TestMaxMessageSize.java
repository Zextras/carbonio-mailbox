...
public class TestMaxMessageSize {
  ...
  public void setUp() throws Exception {
    ...
    mOrigFileUploadMaxSize =
        prov.getLocalServer().getAttr(Provisioning.A_zimbraFileUploadMaxSize, null);
  }
  ...
  public void testLimitByFileUploadMaxSize() throws Exception {
    ...
    try {
      ...
      mbox.uploadContentAsStream(
          "testLimitByFileUploadMaxSize1", in, "application/octet-stream", 3000, 5000);
    ...
    try {
      InputStream in = new ByteArrayInputStream(new byte[3000]);
      mbox.uploadContentAsStream(
          "testLimitByFileUploadMaxSize2", in, "application/octet-stream", 3000, 5000, true);
    } catch (SoapFaultException e) {
