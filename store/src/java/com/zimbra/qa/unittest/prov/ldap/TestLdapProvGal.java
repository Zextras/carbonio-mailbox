...
public class TestLdapProvGal extends LdapTest {
  ...
  public void checkGalConfig() throws Exception {
    ...
    attrs.put(
        Provisioning.A_zimbraGalLdapURL, "ldap://" + LC.zimbra_server_hostname.value() + ":389");
  ...
  public void searchGal() throws Exception {
    ...
    for (int i = 0; i < NUM_ACCTS; i++) {
      String ACCT_NAME_LOCALPART =
          Names.makeAccountNameLocalPart(genAcctNameLocalPart(String.valueOf(i)));
      Account acct = createAccount(ACCT_NAME_LOCALPART);
  ...
  public void searchGalADGroupMember() throws Exception {
    ...
    domainAttrs.put(
        Provisioning.A_zimbraGalLdapGroupHandlerClass, "com.zimbra.cs.gal.ADGalGroupHandler");
