...
public class TestSearchDirectory extends SoapTest {
  ...
  private static void createAccounts(String domainName, int numAccounts) throws Exception {
  ...
  @Test
  @Disabled // takes too long to run, must create at least ldap page size (1000) accounts
  @Bug(bug = 24168)
  ...
  private static class Bug39514 {
    ...
    private static List<TestData> setup() throws Exception {
      ...
      TestData test12 =
          new TestData(adminAcct12Name, PASSWORD, numAcctsInDomain1 + 2); // in admin group 1
      TestData test21 =
          new TestData(
              adminAcct21Name,
              PASSWORD,
              numAcctsInDomain1 + 2 + numAcctsInDomain2 + 2); // in both admin groups
      TestData test22 =
          new TestData(adminAcct22Name, PASSWORD, numAcctsInDomain2 + 2); // in admin group 2
      TestData globalAdmin =
          new TestData(
              globalAdminName,
              PASSWORD,
      ...
      DistributionList adminGroup1 =
          prov.createDistributionList("adminGroup-1" + "@" + domain1Name, adminGroup1Attrs);
      ...
      DistributionList adminGroup2 =
          prov.createDistributionList("adminGroup-2" + "@" + domain2Name, adminGroup2Attrs);
    ...
    private static void doTest(Bug39514.TestData testData) throws Exception {
      ...
      options.setDomain(null);
      options.setTypes(
          SearchDirectoryOptions.ObjectType.accounts, SearchDirectoryOptions.ObjectType.aliases);
      options.setMaxResults(5000);
  ...
  private static class Bug40499 {
    ...
    private static List<TestData> setup() throws Exception {
      ...
      TestData test2 =
          new TestData(allowAdminName, PASSWORD, new String[] {allowDomainName, denyDomainName});
    ...
    private static void doTest(TestData testData) throws Exception {
      ...
      SoapProvisioning prov =
          SoapProvTestUtil.getSoapProvisioning(testData.mAdminName, testData.mAdminPassword);
