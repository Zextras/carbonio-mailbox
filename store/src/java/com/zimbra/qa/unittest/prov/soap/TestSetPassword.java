...
public class TestSetPassword extends SoapTest {
  ...
  private CalendarResource createCRAndSetPasswordpolicy() throws Exception {
    CalendarResource cr =
        provUtil.createCalendarResource(genCalendarResourceNameLocalPart(), domain);
  ...
  public void delegatedAdminWithSetPasswordRight() throws Exception {
    ...
    prov.grantRight(
        ...
        adminAcct.getName(),
        null,
        Right.RT_setAccountPassword,
        null);
    prov.grantRight(
        TargetType.calresource.getCode(),
        TargetBy.name,
        cr.getName(),
        GranteeType.GT_USER.getCode(),
        GranteeBy.name,
        adminAcct.getName(),
        null,
        Right.RT_setCalendarResourcePassword,
        null);
  ...
  public void delegatedAdminWithChangePasswordRight() throws Exception {
    ...
    prov.grantRight(
        ...
        adminAcct.getName(),
        null,
        Right.RT_changeAccountPassword,
        null);
    prov.grantRight(
        TargetType.calresource.getCode(),
        TargetBy.name,
        ...
        adminAcct.getName(),
        null,
        Right.RT_changeCalendarResourcePassword,
        null);
