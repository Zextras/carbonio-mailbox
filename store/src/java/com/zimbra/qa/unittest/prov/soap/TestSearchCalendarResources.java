...
public class TestSearchCalendarResources extends SoapTest {
  ...
  private static void createCalendarResource(
      String localPart,
      Domain domain,
      String displayName,
      CalResType type,
  ...
  private void searchByName(boolean ldap, String domainName) throws Exception {
    ...
    Element request =
        Element.create(
            transport.getRequestProtocol(), AccountConstants.SEARCH_CALENDAR_RESOURCES_REQUEST);
  ...
  private void searchByFilter(boolean ldap, String domainName) throws Exception {
    ...
    eCondResCapacity.addAttribute(
        AccountConstants.A_ENTRY_SEARCH_FILTER_ATTR, "zimbraCalResCapacity");
