...
public class TestLdapReadTimeout {
  ...
  private abstract static class LdapReadTimeoutTester {
    String uri;
    String bindDN;
    String password;
  ...
  private static class UnboundIDTest extends LdapReadTimeoutTester {
    ...
    LDAPConnection connect() throws Exception {
      ...
      try {
        startTime = System.currentTimeMillis();
        conn = new LDAPConnection(connOpts, host, 389, bindDN, password);
  ...
  private static void printSysInfo() throws Exception {
    ...
    System.out.println(
        "System property java.runtime.version=" + System.getProperty("java.runtime.version"));
    ...
    System.out.println(
        "System property sun.arch.data.model=" + System.getProperty("sun.arch.data.model"));
    System.out.println("System property sun.cpu.endian=" + System.getProperty("sun.cpu.endian"));
    // System.out.println("System property sun.cpu.isalist="      +
    // System.getProperty("sun.cpu.isalist"));
    // System.out.println("System property sun.os.patch.level="   +
  ...
  private static void test(LdapReadTimeoutTester tester) {
    ...
    try {
      ...
      while (true) {
        ...
        if (i % 100 == 0) System.out.println("Tested " + i + " iterations");
        ++i;
      }
    } catch (Exception e) {
  ...
  /**
   * /Users/pshao/dev/workspace/sandbox/sandbox/bin>/System/Library/Frameworks/JavaVM.framework/Versions/1.6/Home/bin/java
   * LdapReadTimeout /System/Library/Frameworks/JavaVM.framework/Versions/1.6/Home/bin/java
   * LdapReadTimeout
   *
   * <p>zmjava com.zimbra.qa.unittest.TestLdapReadTimeout -s 5 zmjava
   * com.zimbra.qa.unittest.TestLdapReadTimeout -H ldap://localhost:389 -D
   * uid=zimbra,cn=admins,cn=zimbra -w zimbra -s 5
   *
   * @param args
   */
