...
public class TestLdapZLdapFilter extends LdapTest {
  ...
  private static class LegacyLdapFilter {
    ...
    private static final String FILTER_ACCOUNT_ONLY_OBJECTCLASS =
    ...
    private static final String FILTER_GROUP_OBJECTCLASS =
        "(|(objectClass=zimbraGroup)(objectClass=zimbraDistributionList))";
    ...
    public static String externalAccountsHomedOnServer(String serverServiceHostname) {
      return "(&"
          + FILTER_ACCOUNT_ONLY_OBJECTCLASS
          + externalAccount()
    ...
    public static String accountsByExternalGrant(String granteeEmail) {
      return String.format(
          "(&%s(zimbraSharedItem=granteeId:%s*))", FILTER_ACCOUNT_OBJECTCLASS, granteeEmail);
    }

    public static String accountsByGrants(
        List<String> granteeIds, boolean includePublicShares, boolean includeAllAuthedShares) {
      StringBuilder searchQuery =
          new StringBuilder().append("(&" + FILTER_ACCOUNT_OBJECTCLASS + "(|");
    ...
    public static String accountsOnServerOnCosHasSubordinates(
        String serverServiceHostname, String cosId) {
      return "(&"
          + LegacyLdapFilter.allAccounts()
    ...
    public static String distributionListsByMemberAddrs(String[] memberAddrs) {
      ...
      for (int i = 0; i < memberAddrs.length; i++) {
        sb.append(
            String.format("(%s=%s)", Provisioning.A_zimbraMailForwardingAddress, memberAddrs[i]));
      }
      if (memberAddrs.length > 1) {
        sb.append(")");
      }
    ...
    public static String velodromeAllAccountsByDomainAndServer(
    ...
    public static String velodromeAllAccountsOnlyByDomainAndServer(
        String domainName, String serverServiceHostname) {
      return "(&"
          + FILTER_ACCOUNT_ONLY_OBJECTCLASS
          + homedOnServer(serverServiceHostname)
    ...
    public static String velodromeAllCalendarResourcesByDomainAndServer(
        String domainName, String serverServiceHostname) {
      return "(&"
          + FILTER_CALENDAR_RESOURCE_OBJECTCLASS
          + homedOnServer(serverServiceHostname)
  ...
  private void verify(FilterId filterId, String expected, ZLdapFilter actual) throws Exception {
  ...
  public void fromFilterString() throws Exception {
    ...
    ZLdapFilter zLdapFilter =
        filterDactory.fromFilterString(FilterId.AUTO_PROVISION_SEARCH, FILTER_STR);
  ...
  public void negate() throws Exception {
    ...
    ZLdapFilter zLdapFilter =
        filterDactory.negate(filterDactory.fromFilterString(FilterId.UNITTEST, FILTER));
  ...
  public void accountsHomedOnServerAccountOnly() throws Exception {
    ...
    ZLdapFilter zLdapFilter =
        filterDactory.accountsHomedOnServerAccountsOnly(SERVER.getServiceHostname());
  ...
  public void accountsOnServerAndCosHasSubordinates() throws Exception {
    ...
    String filter =
        LegacyLdapFilter.accountsOnServerOnCosHasSubordinates(SERVER.getServiceHostname(), COS_ID);
    ZLdapFilter zLdapFilter =
        filterDactory.accountsOnServerAndCosHasSubordinates(SERVER.getServiceHostname(), COS_ID);
  ...
  public void accountsByGrants() throws Exception {
    ...
    String filter =
        LegacyLdapFilter.accountsByGrants(GRANTEE_IDS, includePublicShares, includeAllAuthedShares);
    ZLdapFilter zLdapFilter =
        filterDactory.accountsByGrants(GRANTEE_IDS, includePublicShares, includeAllAuthedShares);
  ...
  public void calendarResourcesHomedOnServer() throws Exception {
    ...
    ZLdapFilter zLdapFilter =
        filterDactory.calendarResourcesHomedOnServer(SERVER.getServiceHostname());
  ...
  public void autoProvisionSearchCreatedLaterThan() throws Exception {
    ...
    ZLdapFilter zLdapFilter =
        filterDactory.fromFilterString(FilterId.AUTO_PROVISION_SEARCH_CREATED_LATERTHAN, filter2);
  ...
  public void velodromeAllAccountsByDomainAndServer() throws Exception {
    ...
    String filter =
        LegacyLdapFilter.velodromeAllAccountsByDomainAndServer(
            DOMAIN_NAME, SERVER_SERVICE_HOSTNAME);
    ZLdapFilter zLdapFilter =
        filterDactory.velodromeAllAccountsByDomainAndServer(DOMAIN_NAME, SERVER_SERVICE_HOSTNAME);
  ...
  public void velodromeAllAccountsOnlyByDomainAndServer() throws Exception {
    ...
    String filter =
        LegacyLdapFilter.velodromeAllAccountsOnlyByDomainAndServer(
            DOMAIN_NAME, SERVER_SERVICE_HOSTNAME);
    ZLdapFilter zLdapFilter =
        filterDactory.velodromeAllAccountsOnlyByDomainAndServer(
            DOMAIN_NAME, SERVER_SERVICE_HOSTNAME);
  ...
  public void velodromeAllCalendarResourcesByDomainAndServer() throws Exception {
    ...
    String filter =
        LegacyLdapFilter.velodromeAllCalendarResourcesByDomainAndServer(
            DOMAIN_NAME, SERVER_SERVICE_HOSTNAME);
    ZLdapFilter zLdapFilter =
        filterDactory.velodromeAllCalendarResourcesByDomainAndServer(
            DOMAIN_NAME, SERVER_SERVICE_HOSTNAME);
  ...
  public void toIDNFilter() throws Exception {
    ...
    assertEquals("(objectClass=*)", LdapEntrySearchFilter.toLdapIDNFilter("(objectClass=*)"));

    // this is actually an invalid filter, will throw during search
    assertEquals(
        "(!(objectClass=**))", LdapEntrySearchFilter.toLdapIDNFilter("(!(objectClass=**))"));

    assertEquals(
        "(!(objectClass=*abc))", LdapEntrySearchFilter.toLdapIDNFilter("(!(objectClass=*abc))"));
    ...
    assertEquals(
        "(|(zimbraMailDeliveryAddress=*@test.xn--fiq228c.com)(zimbraMailAlias=*@test.xn--fiq228c.com))",
        LdapEntrySearchFilter.toLdapIDNFilter(
            "(|(zimbraMailDeliveryAddress=*@test.\u4e2d\u6587.com)(zimbraMailAlias=*@test.\u4e2d\u6587.com))"));
  ...
  public void toIDNFilterWithCharsNeedEscaping() throws Exception {
    assertEquals(
        "(objectClass=*\\2a*)", LdapEntrySearchFilter.toLdapIDNFilter("(objectClass=*\\2a*)"));

    assertEquals(
        "(objectClass=*\\28*)", LdapEntrySearchFilter.toLdapIDNFilter("(objectClass=*\\28*)"));

    assertEquals(
        "(objectClass=*\\29*)", LdapEntrySearchFilter.toLdapIDNFilter("(objectClass=*\\29*)"));

    assertEquals(
        "(objectClass=*\\5c*)", LdapEntrySearchFilter.toLdapIDNFilter("(objectClass=*\\5c*)"));
  }
}
