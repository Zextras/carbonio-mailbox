...
public class TestChangePasswordListener extends LdapTest {
  ...
  public void onExceptionAtModifyAttrs01() throws Exception {
    ...
    TestListenerExceptionThrownAtModifyAttrs listener =
        new TestListenerExceptionThrownAtModifyAttrs();
    ...
    // register dummy validator which throws exception when modifyAttrs gets called in
    // LdapProvisioning
    ...
    try {
      ...
      assertTrue(
          e.getMessage()
              .equals("forbidden: password modification is not permitted for this account"));
    }
  ...
  public void onExceptionAtModifyAttrs02() throws Exception {
    ...
    TestListenerExceptionThrownAtModifyAttrs listener =
        new TestListenerExceptionThrownAtModifyAttrs();
    TestListenerExceptionThrownAtModifyAttrs.registerInternal(
        ChangePasswordListener.InternalChangePasswordListenerId.CPL_SYNC, listener);
  ...
  public class TestListenerExceptionThrownAtModifyAttrs extends ChangePasswordListener {
    ...
    public void onException(Account acct, String newPassword, Map context, ServiceException se) {
      onExceptionCalled = true;
      // make sure if ServiceException instance of parameter is same as the one thrown at
      // DummyValidator.
