...
public class TestLdapProvDomain extends LdapTest {
    ...
    SearchLdapOptions searchOpts =
        new SearchLdapOptions(
            ...
            ZLdapFilterFactory.getInstance()
                .fromFilterString(FilterId.UNITTEST, "(objectclass=zimbraDomain)"),
  ...
  private void getDomainByForeignName(String foreignName, String expectedDomainId)
      throws Exception {
    prov.flushCache(CacheEntryType.domain, null);
  ...
  public void testAliasDomain() throws Exception {
    ...
    String realEmail =
        prov.getEmailAddrByDomainAlias(TestUtil.getAddress(USER_LOCAL_PART, ALIAS_DOMAIN_NAME));
    assertEquals(
        IDNUtil.toAscii(TestUtil.getAddress(USER_LOCAL_PART, TARGET_DOMAIN_NAME)), realEmail);
