...
public class TestLdapProvAccount extends LdapTest {
  ...
  public void getAccount() throws Exception {
    ...
    StringUtil.addToMultiMap(
        attrs, Provisioning.A_zimbraForeignPrincipal, KRB5_PRINCIPAL_ATTR_VALUE);
  ...
  public void renameAccount() throws Exception {
    ...
    String ACCT_NEW_NAME =
        TestUtil.getAddress(ACCT_NEW_NAME_LOCALPART, domain.getName()).toLowerCase();
    ...
    assertEquals(
        DATA_SOURCE_ID_1, prov.get(renamedAcct, Key.DataSourceBy.name, DATA_SOURCE_NAME_1).getId());
    assertEquals(
        DATA_SOURCE_ID_2, prov.get(renamedAcct, Key.DataSourceBy.name, DATA_SOURCE_NAME_2).getId());
    assertEquals(
        DATA_SOURCE_ID_3, prov.get(renamedAcct, Key.DataSourceBy.name, DATA_SOURCE_NAME_3).getId());
  ...
  public void renameAccountDomainChanged() throws Exception {
    ...
    String ALIAS_NAME_1 =
        TestUtil.getAddress(ALIAS_NAME_LOCALPART_1, domain.getName()).toLowerCase();
    String ALIAS_NAME_2 =
        TestUtil.getAddress(ALIAS_NAME_LOCALPART_2, domain.getName()).toLowerCase();
    String ALIAS_NEW_NAME_1 =
        TestUtil.getAddress(ALIAS_NAME_LOCALPART_1, NEW_DOMAIN_NAME).toLowerCase();
    String ALIAS_NEW_NAME_2 =
        TestUtil.getAddress(ALIAS_NAME_LOCALPART_2, NEW_DOMAIN_NAME).toLowerCase();
  ...
  public void renameAccountAlreadyExists() throws Exception {
    String ACCT_NAME_LOCALPART = Names.makeAccountNameLocalPart(genAcctNameLocalPart());
    String ACCT_NAME_EXISTS_LOCALPART =
        Names.makeAccountNameLocalPart(genAcctNameLocalPart("exists"));
