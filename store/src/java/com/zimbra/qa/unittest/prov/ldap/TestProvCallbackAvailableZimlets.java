...
public class TestProvCallbackAvailableZimlets extends LdapTest {
  ...
  public static void init() throws Exception {
    ...
    assertTrue(getAttrs.contains("-foo") || getAttrs.contains("+foo") || getAttrs.contains("!foo"));

    assertTrue(getAttrs.contains("-bar") || getAttrs.contains("+bar") || getAttrs.contains("!bar"));
  }
  ...
  public void testReplace() throws Exception {
    ...
    assertTrue(getAttrs.contains("+bar") || getAttrs.contains("!bar"));
  ...
  public void testDelete() throws Exception {
    ...
    assertEquals(3, getAttrs.size());
    assertTrue(
        getAttrs.contains("+foo") && getAttrs.contains("-bar") && getAttrs.contains("!foobar"));
    ...
    assertEquals(2, getAttrs.size());
    assertTrue(getAttrs.contains("-bar") && getAttrs.contains("!foobar"));
  ...
  public void testAdd() throws Exception {
    ...
    assertEquals(4, getAttrs.size());
    assertTrue(
        (getAttrs.contains("!foo") || getAttrs.contains("+foo"))
            && getAttrs.contains("-bar")
            && getAttrs.contains("!foobar")
            && getAttrs.contains("+white"));
  }
