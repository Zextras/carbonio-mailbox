...
public class TestLdapConnection extends LdapTest {
  ...
  private void stopLdap() throws Exception {
    ...
    STOP_LDAP_CMD.add("/opt/zextras/bin/ldap");
  ...
  public void onCheckoutHealthCheck() throws Exception {
    ...
    System.out.println(
        "Before health check, availConns = " + connPool.getCurrentAvailableConnections());
    stopLdap();
    ...
    System.out.println(
        "After health check, availConns = " + connPool.getCurrentAvailableConnections());
    assertEquals(0, connPool.getCurrentAvailableConnections());
  ...
  @Test
  @Disabled // after-exception health check is not supported.
  public void afterExceptionHealthCheck() throws Exception {
    ...
    // LDAPConnectionPool.releaseConnectionAfterException(LDAPConnection connection, LDAPException
    // exception)
  ...
  public void testConnPoolNumAvailConns() throws Exception {
    ...
    LDAPConnectionPool connPool =
        LdapConnectionPool.getConnPoolByName(LdapConnectionPool.CP_ZIMBRA_REPLICA);
