...
public class TestDataSourceServer {
  ...
  public void testOAuthDS() throws Exception {
    ...
    // ZOAuthDataSource zds = new ZOAuthDataSource(DSName, true, refreshToken, folder.getId(),
    // importClassName, ZOAuthDataSource.SOURCE_HOST_YAHOO);
    ...
    assertEquals(
        "expecting import class: " + importClassName, importClassName, ds.getImportClass());
    ...
    assertEquals(
        "expecting host: " + ZDataSource.SOURCE_HOST_YAHOO,
  ...
  public void testScheduling() throws Exception {
    ...
    TestUtil.setDataSourceAttr(
        USER_NAME, zds.getName(), Provisioning.A_zimbraDataSourceEnabled, LdapConstants.LDAP_FALSE);
    checkSchedule(mbox, dsId, null);
  }
