...
public class TestPurge {
  ...
  public void testSystemRetentionPolicy() throws Exception {
    ...
    CreateSystemRetentionPolicyRequest createReq =
        CreateSystemRetentionPolicyRequest.newKeepRequest(keep);
    ...
    ModifySystemRetentionPolicyRequest modifyReq =
        new ModifySystemRetentionPolicyRequest(modLifetime);
