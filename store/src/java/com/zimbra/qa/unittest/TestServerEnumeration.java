...
public class TestServerEnumeration extends TestCase {
  ...
  private static final String MY_CALRES = "calendar_resource1@" + MY_DOMAIN;
  ...
  public void testModifyAccount() throws Exception {
    ...
    grantRightToAdmin(
        ...
        com.zimbra.soap.type.TargetType.fromString(
            com.zimbra.cs.account.accesscontrol.TargetType.account.toString()),
        MY_USER,
        DELEGATED_ADMIN_NAME,
        Admin.R_modifyAccount.getName());
  ...
  public void testModifyAccountSufficientPermissions() throws Exception {
    ...
    grantRightToAdmin(
        adminSoapProv,
        com.zimbra.soap.type.TargetType.fromString(
            com.zimbra.cs.account.accesscontrol.TargetType.global.toString()),
        null,
        DELEGATED_ADMIN_NAME,
        Admin.R_listServer.getName());
    adminSoapProv.flushCache(CacheEntryType.acl, null);
    ModifyAccountRequest req = new ModifyAccountRequest(myUser.getId());
    req.addAttr(new Attr(Provisioning.A_zimbraMailHost, NON_EXISTING_SERVER));
    req.addAttr(new Attr(Provisioning.A_description, "test description"));
    try {
      ...
      assertEquals(
          "should be getting 'no such server' response",
  ...
  public void testModifyCalres() throws Exception {
    ...
    grantRightToAdmin(
        adminSoapProv,
        com.zimbra.soap.type.TargetType.fromString(
            com.zimbra.cs.account.accesscontrol.TargetType.calresource.toString()),
        MY_CALRES,
        DELEGATED_ADMIN_NAME,
