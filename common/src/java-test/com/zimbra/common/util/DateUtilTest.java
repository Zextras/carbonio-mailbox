...
public final class DateUtilTest {
  ...
  public void parseISO8601Date() throws Exception {
    ...
    Assert.assertEquals(
        "Ignore Z", cal.getTime(), DateUtil.parseISO8601Date("2009-11-20T13:55:49Z", new Date(0L)));
    ...
    Assert.assertEquals(
        "Ignore .724z",
        cal.getTime(),
        DateUtil.parseISO8601Date("2009-11-20t13:55:49.724z", new Date(0L)));
  }
  ...
  public void parseRFC2822Date() throws Exception {
    ...
    Assert.assertEquals(
        cal.getTime(), DateUtil.parseRFC2822Date("01 May 2007 09:27 -0600", new Date(0L)));

    cal.clear();
    cal.setTimeZone(TimeZone.getTimeZone("GMT-08:00"));
    cal.set(2005, 3, 1, 18, 20, 24);
    Assert.assertEquals(
        cal.getTime(), DateUtil.parseRFC2822Date("01 Apr 2005 18:20:24 -0800", new Date(0L)));

    cal.clear();
    cal.setTimeZone(TimeZone.getTimeZone("GMT-07:00"));
    cal.set(2003, 9, 10, 12, 52, 52);
    Assert.assertEquals(
        cal.getTime(), DateUtil.parseRFC2822Date("Fri, 10 Oct 2003 12:52:52 -0700", new Date(0L)));
    ...
    Assert.assertEquals(
        cal.getTime(), DateUtil.parseRFC2822Date("Wed, 27 Apr 2005 15:37:37 PDT", new Date(0L)));

    cal.clear();
    cal.setTimeZone(TimeZone.getTimeZone("GMT"));
    cal.set(1997, 10, 21, 9, 55, 6);
    Assert.assertEquals(
        cal.getTime(), DateUtil.parseRFC2822Date("21 Nov 97 09:55:06 GMT", new Date(0L)));
    ...
    Assert.assertEquals(
        cal.getTime(), DateUtil.parseRFC2822Date("21 Nov 97 09::06 GMT", new Date(0L)));

    cal.clear();
    cal.setTimeZone(TimeZone.getTimeZone("GMT-05:00"));
    cal.set(1997, 10, 21, 9, 55, 6);
    Assert.assertEquals(
        cal.getTime(), DateUtil.parseRFC2822Date("21 nOV 97 09:55:06 R", new Date(0L)));

    cal.clear();
    cal.setTimeZone(TimeZone.getTimeZone("GMT"));
    cal.set(2006, 10, 21, 9, 55, 6);
    Assert.assertEquals(
        cal.getTime(), DateUtil.parseRFC2822Date("21 11 06 09:55:06 GMT", new Date(0L)));

    cal.clear();
    cal.setTimeZone(TimeZone.getDefault());
    cal.set(2009, 7, 3, 22, 35, 13);
    Assert.assertEquals(
        cal.getTime(), DateUtil.parseRFC2822Date("Mon Aug  3 22:35:13 2009", new Date(0L)));

    cal.clear();
    cal.setTimeZone(TimeZone.getTimeZone("GMT-05:00"));
    cal.set(2009, 5, 5, 12, 6, 22);
    Assert.assertEquals(
        cal.getTime(), DateUtil.parseRFC2822Date("Fri Jun 05 12:06:22 CDT 2009", new Date(0L)));

    cal.clear();
    cal.setTimeZone(TimeZone.getTimeZone("GMT-05:00"));
    cal.set(2009, 3, 2, 23, 28, 18);
    Assert.assertEquals(
        cal.getTime(), DateUtil.parseRFC2822Date("Thu Apr 02 23:28:18 CDT 2009", new Date(0L)));

    cal.clear();
    cal.setTimeZone(TimeZone.getTimeZone("GMT-06:00"));
    cal.set(2009, 2, 7, 2, 53, 31);
    Assert.assertEquals(
        cal.getTime(), DateUtil.parseRFC2822Date("Sat Mar 07 02:53:31 CST 2009", new Date(0L)));

    cal.clear();
    cal.setTimeZone(TimeZone.getTimeZone("GMT-06:00"));
    cal.set(2009, 1, 27, 11, 5, 49);
    Assert.assertEquals(
        cal.getTime(), DateUtil.parseRFC2822Date("Fri Feb 27 11:05:49 CST 2009", new Date(0L)));

    cal.clear();
    cal.setTimeZone(TimeZone.getTimeZone("GMT-06:00"));
    cal.set(2009, 1, 6, 15, 56, 40);
    Assert.assertEquals(
        cal.getTime(), DateUtil.parseRFC2822Date("Fri Feb 06 15:56:40 CST 2009", new Date(0L)));

    cal.clear();
    cal.setTimeZone(TimeZone.getTimeZone("GMT-06:00"));
    cal.set(2008, 11, 11, 22, 10, 4);
    Assert.assertEquals(
        cal.getTime(), DateUtil.parseRFC2822Date("Thu Dec 11 22:10:04 CST 2008", new Date(0L)));

    cal.clear();
    cal.setTimeZone(TimeZone.getTimeZone("GMT-08:00"));
    cal.set(2008, 2, 8, 20, 33, 2);
    Assert.assertEquals(
        cal.getTime(), DateUtil.parseRFC2822Date("Sat Mar 08 20:33:02 PST 2008", new Date(0L)));

    cal.clear();
    cal.setTimeZone(TimeZone.getTimeZone("GMT-06:00"));
    cal.set(2007, 11, 19, 22, 11, 4);
    Assert.assertEquals(
        cal.getTime(), DateUtil.parseRFC2822Date("Wed Dec 19 22:11:04 CST 2007", new Date(0L)));

    cal.clear();
    cal.setTimeZone(TimeZone.getDefault());
    cal.set(2001, 8, 26, 16, 30, 37);
    Assert.assertEquals(
        cal.getTime(), DateUtil.parseRFC2822Date("Wed, 26 Sep 2001 16:30:37", new Date(0L)));

    cal.clear();
    cal.setTimeZone(TimeZone.getDefault());
    cal.set(2001, 8, 25, 13, 20, 59);
    Assert.assertEquals(
        cal.getTime(), DateUtil.parseRFC2822Date("Tue, 25 Sep 2001 13:20:59", new Date(0L)));
  }

  @Test
  public void toImapDateTime() throws Exception {
    Assert.assertEquals(
        "31-Dec-1969 16:00:00 -0800",
        DateUtil.toImapDateTime(new Date(0L), TimeZone.getTimeZone("US/Pacific")));
  }
    ...
    if (cal != null) {
      java.text.DateFormat format =
          java.text.DateFormat.getDateTimeInstance(
              java.text.DateFormat.SHORT, java.text.DateFormat.SHORT, java.util.Locale.UK);
