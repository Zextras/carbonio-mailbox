...
public class QuotedTextUtilTest {
   ...
   * com.zimbra.common.util.QuotedTextUtil#getOriginalContent(java.lang.String, boolean)}.
   */
  @Test
  public void testGetOriginalContent() {
    ...
    String content =
        "Hello Roland, nope, there's no way of modifying the javadocs.\nDavid\n"
    ...
    content =
        "<fixed><bigger><bigger>Thanks for the help.  It has been invaluable.\n"
            + "Tom Condon\n"
            + "</bigger></bigger></fixed>\n"
    ...
    content =
        "<html><body><div style=\"font-family: verdana,helvetica,sans-serif; font-size: 10pt;"
            + " color: #000000\"><div>Venue Details as Below. Please be there by 07:00PM today"
            + " evening.</div><hr id=\"zwchr\">The following is a new meeting request:"
            + " <br><br>Subject: Dinner with Thom <br>Organizer: &quot;Avanti Gowaikar (C)&quot;"
            + " &lt;agowaikar@zimbra.com&gt;<br><br>Time: Wednesday, January 28, 2015, 7:00:00 PM -"
            + " 10:00:00 PM GMT +05:30 Chennai, Kolkata, Mumbai, New Delhi <br><br>Invitees:"
            + " pune-employees@zimbra.com <br><br><br>*~*~*~*~*~*~*~*~*~*<br></div></body></html>";
    ...
    expected =
        "<HTML>\n"
            ...
            + " color: #000000\">\n"
            + "            <DIV>Venue Details as Below. Please be there by 07:00PM today"
            + " evening.</DIV>\n"
            + "        </DIV>\n"
            + "    </BODY>\n"
            + "</HTML>\n";
    ...
    content =
        "<div dir=\"ltr\"><div class=\"gmail_quote\"><br><br><br><div dir=\"ltr\">"
    ...
    originalContent = quotedTextUtil.getOriginalContent(content, true);
    expected =
        "<div dir=\"ltr\"><div class=\"gmail_quote\"><br><br><br><div dir=\"ltr\"><span"
            + " style=\"font-size:12.8000001907349px\">asdasdasdasasfasfasfasfasfasfa</span><span"
            + " class=\"HOEnZb\"><font color=\"#888888\"><br clear=\"all\"><div><br></div>--"
            + " <br><div><div dir=\"ltr\">Thanks and regards,<div>Saurabh</div></div></div></font>"
            + "</span></div></div>";
    Assert.assertEquals(expected, originalContent);

    content =
        "<div dir=\"ltr\">This is my reply<br><div><div class=\"gmail_extra\"><br>"
