...
public class ServerTest {
  ...
  private static final String[] messages = {
    "The World Bank chose Korean-American physician Jim Yong Kim as its next chief Monday in a"
        + " decision that surprised few despite the first-ever challenge to the US lock on the"
        + " Bank's presidency.",
    "The 2012 Pulitzer Prize winners and nominated finalists were announced on Monday. The New York"
        + " Times won a pair of Pulitzers--for explanatory writing (David Kocieniewski's series on"
        + " tax loopholes for the wealthy) and international reporting (Jeffrey Gettleman's 'vivid"
        + " reports, often at personal peril, on famine and conflict in East Africa')--while the"
        + " Associated Press was recognized for an investigative series--by Matt Apuzzo, Adam"
        + " Goldman, Chris Hawley and Eileen Sullivan--outlining the New York Police Departments"
        + " surveillance of minority and Muslim neighborhoods since the 9/11 terror attacks.",
    "Clean-up efforts were underway across the Midwest after dozens of tornadoes tore through the"
        + " region over the weekend of Apr. 14, killing five people in Oklahoma and nearly"
        + " destroying one small Iowa town.",
    "A Michigan woman who continued to get food stamps after winning a lottery jackpot was"
        + " arraigned Tuesday on welfare fraud charges. Amanda Clayton, 25, of Lincoln Park was"
        + " arrested on Monday. If convicted of the two felony charges, she could face up to four"
        + " years in prison.",
  };
  ...
  @Test
  public void testOneServerDown() throws Exception {
    CountDownLatch latch1 = new CountDownLatch(2);
    CountDownLatch latch2 = new CountDownLatch(2);
    s1.registerCallback(new CountDownCallback(latch1));
    s2.registerCallback(new CountDownCallback(latch2));
