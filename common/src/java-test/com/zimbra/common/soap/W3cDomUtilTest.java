...
public class W3cDomUtilTest {
  ...
  @Test
  public void testMakeSAXParserFactory()
      throws XmlParseException, SAXNotRecognizedException, SAXNotSupportedException,
  ...
  @Test
  public void testGetDom4jSAXReaderWhichUsesSecureProcessing()
  ...
  public void testRemoveInvalidChars() throws IOException {
    String invalidCharsXML =
        "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
            + "\n"
            + "<backupMetadata xmlns=\"urn:zimbraBackupMeta\" version=\"7.1\">\n"
            + "  <accountLdap zimbraId=\"3f38c5be-1b08-463c-8326-d7e26b2a515a\""
            + " email=\"account1@zcs804.zimbra.com\">\n"
            + "    <attributes>\n"
            + "      <attribute name=\"zimbraMailSieveScript\">\n"
            + "        <value>require [\"fileinto\", \"reject\", \"tag\", \"flag\"];\n"
            + "\n"
            + "# filter1\n"
            + "if allof (address :all :contains :comparator \"i;ascii-casemap\" [\"from\"]"
            + " \"foo&#7;bar &lt;acco&#7;unt2@zcs804.zimbra.com&gt;\",\n"
    ...
    String validCharsXML =
        "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
            ...
            + "\n"
            + "# filter1\n"
            + "if allof (address :all :contains :comparator \"i;ascii-casemap\" [\"from\"] \"foobar"
            + " &lt;account2@zcs804.zimbra.com&gt;\",\n"
            + "  header :is [\"subject\"] \"foobar &lt;account2@zcs804.zimbra.com&gt;\") {\n"
            + "    keep;\n"
            + "    stop;\n"
            + "}\n"
